...
# **getCustomerSource**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20075 getCustomerSource($customer_source_id, $accept_language)
...
# **getCustomerSources**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20074 getCustomerSources($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_source_text_id)
