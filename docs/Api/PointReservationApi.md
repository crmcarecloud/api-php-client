...
# **getPointReservation**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20068 getPointReservation($point_reservation_id, $accept_language)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20067 getPointReservations($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id)
