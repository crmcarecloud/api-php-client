...
# **getRewardProperties**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20099 getRewardProperties($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
...
# **getRewardProperty**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20034 getRewardProperty($reward_property_id, $accept_language)
