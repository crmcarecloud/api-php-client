...
$apiInstance = new CareCloud\Api\RewardPropertiesApi(
...
# **getRewardProperty**
> \CareCloud\Model\InlineResponse20034 getRewardProperty($reward_property_id, $accept_language)
