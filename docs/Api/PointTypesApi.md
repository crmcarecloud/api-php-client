...
# **getPointType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20092 getPointType($point_type_id, $accept_language)
...
# **getPointsTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20091 getPointsTypes($accept_language, $count, $offset, $sort_field, $sort_direction)
