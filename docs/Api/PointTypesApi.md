...
# **getPointType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20088 getPointType($point_type_id, $accept_language)
...
# **getPointsTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20087 getPointsTypes($accept_language, $count, $offset, $sort_field, $sort_direction)
