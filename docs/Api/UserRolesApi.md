...
# **getUserRole**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200175 getUserRole($user_role_id, $accept_language)
...
# **getUserRoles**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200174 getUserRoles($accept_language, $count, $offset, $sort_field, $sort_direction)
