...
# **getOrder**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20082 getOrder($order_id, $accept_language)
...
# **getOrders**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20081 getOrders($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $state)
