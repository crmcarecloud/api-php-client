...
# **getOrder**
> \CareCloud\Model\InlineResponse20055 getOrder($order_id, $accept_language)
...
# **getOrders**
> \CareCloud\Model\InlineResponse20054 getOrders($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $state)
