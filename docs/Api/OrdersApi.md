...
# **getOrder**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20083 getOrder($order_id, $accept_language)
...
# **getOrders**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20082 getOrders($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $state)
...
# **postOrder**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20115 postOrder($body, $accept_language)
