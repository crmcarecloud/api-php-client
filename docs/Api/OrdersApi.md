...
# **getOrder**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20069 getOrder($order_id, $accept_language)
...
# **getOrders**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20068 getOrders($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $state)
...
# **postOrder**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20113 postOrder($body, $accept_language)
