...
# **getCountries**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetCountries200Response getCountries($accept_language, $count, $offset, $sort_field, $sort_direction, $country_id, $country_name)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetCountries200Response**](../Model/GetCountries200Response.md)
