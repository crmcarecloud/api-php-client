...
# **getCountries**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20024 getCountries($accept_language, $count, $offset, $sort_field, $sort_direction, $country_id, $country_name)
