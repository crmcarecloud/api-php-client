...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20076 getProductProperties($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
...
# **getProductProperty**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20035 getProductProperty($product_property_id, $accept_language)
