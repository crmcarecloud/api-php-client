# CareCloud\ProductPropertiesApi
...
$apiInstance = new CareCloud\Api\ProductPropertiesApi(
...
# **getProductProperty**
> \CareCloud\Model\InlineResponse20034 getProductProperty($product_property_id, $accept_language)
