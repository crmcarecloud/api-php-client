...
# **getCampaign**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20013 getCampaign($campaign_id, $accept_language)
...
# **getCampaigns**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20012 getCampaigns($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
