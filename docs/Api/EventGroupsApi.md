...
# **getEventGroup**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20053 getEventGroup($event_group_id, $accept_language)
...
# **getEventGroups**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20052 getEventGroups($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $text_id)
