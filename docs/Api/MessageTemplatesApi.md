...
# **getMessageTemplate**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20078 getMessageTemplate($message_template_id, $accept_language)
...
# **getMessageTemplates**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20077 getMessageTemplates($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $communication_channel_id)
