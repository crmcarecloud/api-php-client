...
# **getMessageTemplate**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20054 getMessageTemplate($message_template_id, $accept_language)
...
# **getMessageTemplates**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20053 getMessageTemplates($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
