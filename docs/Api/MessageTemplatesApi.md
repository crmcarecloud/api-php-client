...
# **getMessageTemplate**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20058 getMessageTemplate($message_template_id, $accept_language)
...
# **getMessageTemplates**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20057 getMessageTemplates($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
