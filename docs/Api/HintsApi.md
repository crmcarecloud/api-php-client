...
# **getRecommendation**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200135 getRecommendation($recommendation_id, $accept_language)
...
# **getRecommendations**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200134 getRecommendations($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
