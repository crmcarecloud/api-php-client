...
# **getRecommendation**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200133 getRecommendation($recommendation_id, $accept_language)
...
# **getRecommendations**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200132 getRecommendations($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
