...
# **getProductBrand**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20092 getProductBrand($product_brand_id, $accept_language)
...
# **getProductBrands**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20091 getProductBrands($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
