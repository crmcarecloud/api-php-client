...
# **getProductBrand**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200114 getProductBrand($product_brand_id, $accept_language)
...
# **getProductBrands**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200113 getProductBrands($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
