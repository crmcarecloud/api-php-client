...
# **getProductBrand**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200103 getProductBrand($product_brand_id, $accept_language)
...
# **getProductBrands**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200102 getProductBrands($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
