# CrmCareCloud\Webservice\RestApi\Client\CustomerTypesApi

All URIs are relative to *https://{project_url}/webservice/rest-api/{api_interface}/{version}*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getCustomerType**](CustomerTypesApi.md#getcustomertype) | **GET** /customer-types/{customer_type_id} | Detail of a customer type
[**getCustomerTypes**](CustomerTypesApi.md#getcustomertypes) | **GET** /customer-types | Get all customer types

# **getCustomerType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerType200Response getCustomerType($customer_type_id, $accept_language)
...
$apiInstance = new CrmCareCloud\Webservice\RestApi\Client\Api\CustomerTypesApi(
...
try {
    ...
    echo 'Exception when calling CustomerTypesApi->getCustomerType: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerType200Response**](../Model/GetCustomerType200Response.md)
...
# **getCustomerTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerTypes200Response getCustomerTypes($accept_language, $count, $offset, $sort_field, $sort_direction)
...
try {
    $result = $apiInstance->getCustomerTypes($accept_language, $count, $offset, $sort_field, $sort_direction);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CustomerTypesApi->getCustomerTypes: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerTypes200Response**](../Model/GetCustomerTypes200Response.md)
