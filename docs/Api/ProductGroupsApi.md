...
# **getProductGroup**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetProductGroup200Response getProductGroup($product_group_id, $accept_language)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetProductGroup200Response**](../Model/GetProductGroup200Response.md)
...
# **getProductGroups**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetProductGroups200Response getProductGroups($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $store_id, $code, $external_id)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetProductGroups200Response**](../Model/GetProductGroups200Response.md)
