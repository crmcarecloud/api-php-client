...
# **getPaymentType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20091 getPaymentType($payment_type_id, $accept_language)
...
# **getPaymentTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20090 getPaymentTypes($accept_language, $count, $offset, $sort_field, $sort_direction)
