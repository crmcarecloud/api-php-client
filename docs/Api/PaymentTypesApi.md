...
# **getPaymentType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20092 getPaymentType($payment_type_id, $accept_language)
...
# **getPaymentTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20091 getPaymentTypes($accept_language, $count, $offset, $sort_field, $sort_direction)
