...
# **getPaymentType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetPaymentType200Response getPaymentType($payment_type_id, $accept_language)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetPaymentType200Response**](../Model/GetPaymentType200Response.md)
...
# **getPaymentTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetPaymentTypes200Response getPaymentTypes($accept_language, $count, $offset, $sort_field, $sort_direction)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetPaymentTypes200Response**](../Model/GetPaymentTypes200Response.md)
