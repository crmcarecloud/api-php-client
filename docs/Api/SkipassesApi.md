...
# **getSkipass**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200118 getSkipass($skipass_id, $accept_language)
...
# **getSkipasses**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200117 getSkipasses($accept_language, $count, $offset, $sort_field, $sort_direction, $pos_id, $external_order_id, $name, $resort_name, $customer_category_name, $card_id, $customer_id, $skipass_type_id, $state, $external_skipass_id, $is_valid, $is_cancelled)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200119 getSkipassesOverview($accept_language, $valid_from, $valid_to)
