...
# **getProduct**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20072 getProduct($product_id, $accept_language)
...
# **getProducts**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20071 getProducts($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code, $external_id, $external_type_code)
