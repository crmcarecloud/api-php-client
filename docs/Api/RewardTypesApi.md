...
# **getRewardTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetRewardTypes200Response getRewardTypes($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetRewardTypes200Response**](../Model/GetRewardTypes200Response.md)
...
# **getRewardtype**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetRewardType200Response getRewardtype($reward_type_id, $accept_language)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetRewardType200Response**](../Model/GetRewardType200Response.md)
