...
$apiInstance = new CareCloud\Api\StoreGroupsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$store_group_id = "store_group_id_example"; // string | The unique id for the store group
...
------------- | ------------- | ------------- | -------------
 **store_group_id** | **string**| The unique id for the store group |
