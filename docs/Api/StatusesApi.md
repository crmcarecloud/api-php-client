...
# **getStatus**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetStatus200Response getStatus($status_id, $accept_language)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetStatus200Response**](../Model/GetStatus200Response.md)
...
# **getStatuses**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetStatuses200Response getStatuses($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id)
...
try {
    $result = $apiInstance->getStatuses($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id);
    print_r($result);
} catch (Exception $e) {
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetStatuses200Response**](../Model/GetStatuses200Response.md)
