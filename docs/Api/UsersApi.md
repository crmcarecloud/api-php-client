...
# **getUser**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200142 getUser($user_id, $accept_language)
...
# **getUsers**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200141 getUsers($accept_language, $count, $offset, $sort_field, $sort_direction, $email, $phone, $login, $first_name, $last_name)
...
# **postUserLogin**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200144 postUserLogin($body, $accept_language)
...
# **postUserSsoLogin**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200145 postUserSsoLogin($body, $accept_language)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200143 postUserVerifyAuthToken($body)
