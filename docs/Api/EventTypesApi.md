...
# **getEventType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20069 getEventType($event_type_id, $accept_language)
...
# **getEventTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20068 getEventTypes($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20070 getSubEventTypeProperties($event_type_id, $accept_language, $count, $offset, $sort_field, $sort_direction)
