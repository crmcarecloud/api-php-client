...
# **getEventType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20084 getEventType($event_type_id, $accept_language)
...
# **getEventTypes**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20083 getEventTypes($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20085 getSubEventTypeProperties($event_type_id, $accept_language, $count, $offset, $sort_field, $sort_direction)
