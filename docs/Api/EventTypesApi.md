# CrmCareCloud\Webservice\RestApi\Client\EventTypesApi

All URIs are relative to *https://{project_url}/webservice/rest-api/{api_interface}/{version}*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getEventType**](EventTypesApi.md#geteventtype) | **GET** /event-types/{event_type_id} | Get an event type
[**getEventTypes**](EventTypesApi.md#geteventtypes) | **GET** /event-types | Get all event types
...
# **getEventType**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetEventType200Response getEventType($event_type_id, $accept_language)
...
$apiInstance = new CrmCareCloud\Webservice\RestApi\Client\Api\EventTypesApi(
...
try {
    ...
    echo 'Exception when calling EventTypesApi->getEventType: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetEventType200Response**](../Model/GetEventType200Response.md)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetEventTypes200Response**](../Model/GetEventTypes200Response.md)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetSubEventTypeProperties200Response getSubEventTypeProperties($event_type_id, $accept_language, $count, $offset, $sort_field, $sort_direction)
...
try {
    $result = $apiInstance->getSubEventTypeProperties($event_type_id, $accept_language, $count, $offset, $sort_field, $sort_direction);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EventTypesApi->getSubEventTypeProperties: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetSubEventTypeProperties200Response**](../Model/GetSubEventTypeProperties200Response.md)
