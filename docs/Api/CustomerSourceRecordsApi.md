...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20032 getCustomerSourceRecords($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id, $customer_source_id)
