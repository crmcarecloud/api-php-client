...
# **getEvent**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20042 getEvent($event_id, $accept_language)
...
# **getEvents**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20041 getEvents($accept_language, $count, $offset, $sort_field, $sort_direction, $event_type_id)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20043 getSubEventProperties($event_id, $accept_language)
