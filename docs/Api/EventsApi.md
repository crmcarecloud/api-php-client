...
# **getEvent**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20053 getEvent($event_id, $accept_language)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20054 getSubEventProperties($event_id, $accept_language)
