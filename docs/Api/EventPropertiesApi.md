...
# **getEventProperties**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetEventProperties200Response getEventProperties($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetEventProperties200Response**](../Model/GetEventProperties200Response.md)
...
# **getEventProperty**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetEventProperty200Response getEventProperty($event_property_id, $accept_language)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetEventProperty200Response**](../Model/GetEventProperty200Response.md)
