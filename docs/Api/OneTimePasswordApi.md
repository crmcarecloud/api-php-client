...
# **postSendOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20059 postSendOtp($body, $accept_language)
...
# **postVerifyOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20060 postVerifyOtp($body, $accept_language)
