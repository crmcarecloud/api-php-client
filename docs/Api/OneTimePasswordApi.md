...
# **postSendOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20069 postSendOtp($body, $accept_language)
...
# **postVerifyOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20070 postVerifyOtp($body, $accept_language)
