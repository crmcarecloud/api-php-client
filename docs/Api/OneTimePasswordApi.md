...
# **postSendOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20068 postSendOtp($body, $accept_language)
...
# **postVerifyOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20069 postVerifyOtp($body, $accept_language)
