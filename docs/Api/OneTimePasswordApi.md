...
# **postSendOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20055 postSendOtp($body, $accept_language)
...
# **postVerifyOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20056 postVerifyOtp($body, $accept_language)
