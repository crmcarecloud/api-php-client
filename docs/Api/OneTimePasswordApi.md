...
# **postSendOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20075 postSendOtp($body, $accept_language)
...
# **postVerifyOtp**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20076 postVerifyOtp($body, $accept_language)
