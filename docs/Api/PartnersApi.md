...
# **getPartner**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20057 getPartner($partner_id, $accept_language)
...
$partner_id = "partner_id_example"; // string | The unique id for the partner
...
# **getPartners**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20056 getPartners($accept_language, $count, $offset, $sort_field, $sort_direction)
