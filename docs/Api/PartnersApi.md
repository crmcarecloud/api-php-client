# CrmCareCloud\Webservice\RestApi\Client\PartnersApi
...
# **getPartner**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetPartner200Response getPartner($partner_id, $accept_language)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetPartner200Response**](../Model/GetPartner200Response.md)
...
# **getPartners**
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetPartners200Response getPartners($accept_language, $count, $offset, $sort_field, $sort_direction)
...
try {
    $result = $apiInstance->getPartners($accept_language, $count, $offset, $sort_field, $sort_direction);
    print_r($result);
} catch (Exception $e) {
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetPartners200Response**](../Model/GetPartners200Response.md)
...
> \CrmCareCloud\Webservice\RestApi\Client\Model\GetSubPartnerProperties200Response getSubPartnerProperties($partner_id, $accept_language)
...
[**\CrmCareCloud\Webservice\RestApi\Client\Model\GetSubPartnerProperties200Response**](../Model/GetSubPartnerProperties200Response.md)
