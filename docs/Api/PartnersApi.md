...
# **getPartner**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20061 getPartner($partner_id, $accept_language)
...
# **getPartners**
> \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20060 getPartners($accept_language, $count, $offset, $sort_field, $sort_direction)
