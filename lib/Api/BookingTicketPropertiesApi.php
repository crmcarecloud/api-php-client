...
/**
 * BookingTicketPropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BookingTicketPropertiesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation getBookingTicketProperties
     *
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2007
     */
    public function getBookingTicketProperties($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getBookingTicketPropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getBookingTicketPropertiesWithHttpInfo
     *
     * Get all booking ticket properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2007, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBookingTicketPropertiesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2007';
        $request = $this->getBookingTicketPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2007',
    ...
    /**
     * Operation getBookingTicketPropertiesAsync
     *
     * Get all booking ticket properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getBookingTicketPropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getBookingTicketPropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBookingTicketPropertiesAsyncWithHttpInfo
     *
     * Get all booking ticket properties
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookingTicketPropertiesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2007';
        $request = $this->getBookingTicketPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getBookingTicketProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getBookingTicketPropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/booking-ticket-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getBookingTicketProperty
     *
     * Get a booking ticket property
     *
     * @param  string $booking_ticket_property_id The unique ID of the booking ticket property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getBookingTicketProperty($booking_ticket_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getBookingTicketPropertyWithHttpInfo($booking_ticket_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getBookingTicketPropertyWithHttpInfo
     *
     * Get a booking ticket property
     *
     * @param  string $booking_ticket_property_id The unique ID of the booking ticket property. (required)
     ...
     */
    public function getBookingTicketPropertyWithHttpInfo($booking_ticket_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getBookingTicketPropertyRequest($booking_ticket_property_id, $accept_language);
    ...
    /**
     * Operation getBookingTicketPropertyAsync
     *
     * Get a booking ticket property
     *
     * @param  string $booking_ticket_property_id The unique ID of the booking ticket property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookingTicketPropertyAsync($booking_ticket_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getBookingTicketPropertyAsyncWithHttpInfo($booking_ticket_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBookingTicketPropertyAsyncWithHttpInfo
     *
     * Get a booking ticket property
     *
     * @param  string $booking_ticket_property_id The unique ID of the booking ticket property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookingTicketPropertyAsyncWithHttpInfo($booking_ticket_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getBookingTicketPropertyRequest($booking_ticket_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getBookingTicketProperty'
     *
     * @param  string $booking_ticket_property_id The unique ID of the booking ticket property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBookingTicketPropertyRequest($booking_ticket_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'booking_ticket_property_id' is set
        if ($booking_ticket_property_id === null || (is_array($booking_ticket_property_id) && count($booking_ticket_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $booking_ticket_property_id when calling getBookingTicketProperty'
            );
        }

        $resourcePath = '/booking-ticket-properties/{booking_ticket_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($booking_ticket_property_id !== null) {
            $resourcePath = str_replace(
                ...
                ObjectSerializer::toPathValue($booking_ticket_property_id),
                $resourcePath
            );
        }
