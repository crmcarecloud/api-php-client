...
/**
 * EventGroupsApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class EventGroupsApi
{
    ...
    /**
     * Operation getEventGroup
     *
     * Get an event group
     *
     * @param  string $event_group_id The unique ID of the event group. (required)
    ...
    {
        list($response) = $this->getEventGroupWithHttpInfo($event_group_id, $accept_language);
        return $response;
    }

    /**
     * Operation getEventGroupWithHttpInfo
     *
     * Get an event group
     *
     * @param  string $event_group_id The unique ID of the event group. (required)
     ...
     */
    public function getEventGroupAsync($event_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getEventGroupAsyncWithHttpInfo($event_group_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEventGroupAsyncWithHttpInfo
     *
     * Get an event group
     *
     * @param  string $event_group_id The unique ID of the event group. (required)
    ...
    /**
     * Create request for operation 'getEventGroup'
     *
     * @param  string $event_group_id The unique ID of the event group. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getEventGroupRequest($event_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        ...
        if ($event_group_id === null || (is_array($event_group_id) && count($event_group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_group_id when calling getEventGroup'
            );
        }

        $resourcePath = '/event-groups/{event_group_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getEventGroupsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $text_id);
        return $response;
    }

    /**
     * Operation getEventGroupsWithHttpInfo
     *
     * Get all event groups
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventGroupsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $text_id = null)
    {
        return $this->getEventGroupsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $text_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEventGroupsAsyncWithHttpInfo
     *
     * Get all event groups
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Create request for operation 'getEventGroups'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEventGroupsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $text_id = null)
    {

        $resourcePath = '/event-groups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
