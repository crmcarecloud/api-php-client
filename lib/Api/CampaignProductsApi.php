...
class CampaignProductsApi
{
    ...
    /**
     * Operation getCampaignProduct
     *
     * Detail of a specific campaign product
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
    ...
    {
        list($response) = $this->getCampaignProductWithHttpInfo($campaign_product_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCampaignProductWithHttpInfo
     *
     * Detail of a specific campaign product
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
    ...
    /**
     * Operation getCampaignProductAsync
     *
     * Detail of a specific campaign product
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
     ...
     */
    public function getCampaignProductAsync($campaign_product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCampaignProductAsyncWithHttpInfo($campaign_product_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCampaignProductAsyncWithHttpInfo
     *
     * Detail of a specific campaign product
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
    ...
    /**
     * Create request for operation 'getCampaignProduct'
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getCampaignProductRequest($campaign_product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'campaign_product_id' is set
        if ($campaign_product_id === null || (is_array($campaign_product_id) && count($campaign_product_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_product_id when calling getCampaignProduct'
            );
        }

        $resourcePath = '/campaign-products/{campaign_product_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($campaign_product_id !== null) {
            $resourcePath = str_replace(
                '{' . 'campaign_product_id' . '}',
                ObjectSerializer::toPathValue($campaign_product_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getCampaignProductStoreRecords
     *
    ...
    {
        list($response) = $this->getCampaignProductStoreRecordsWithHttpInfo($campaign_product_id, $accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getCampaignProductStoreRecordsWithHttpInfo
     *
     * Get a campaign product store records
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
    ...
    /**
     * Operation getCampaignProductStoreRecordsAsync
     *
     * Get a campaign product store records
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignProductStoreRecordsAsync($campaign_product_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getCampaignProductStoreRecordsAsyncWithHttpInfo($campaign_product_id, $accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCampaignProductStoreRecordsAsyncWithHttpInfo
     *
     * Get a campaign product store records
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
    ...
    /**
     * Create request for operation 'getCampaignProductStoreRecords'
     *
     * @param  string $campaign_product_id The unique ID of the campaign product in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCampaignProductStoreRecordsRequest($campaign_product_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        // verify the required parameter 'campaign_product_id' is set
        if ($campaign_product_id === null || (is_array($campaign_product_id) && count($campaign_product_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_product_id when calling getCampaignProductStoreRecords'
            );
        }

        $resourcePath = '/campaign-products/{campaign_product_id}/campaign-product-store-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $display_in Place to display campaign product. (optional)
     * @param  string[] $type_id Type of the customer for a campaign product. (optional)
     * @param  string $store_id Parameter filters all campaign products from [store](#tag/Stores) by store ID. (optional)
    ...
    {
        list($response) = $this->getCampaignProductsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code, $display_in, $type_id, $store_id, $value_type_id, $is_valid, $valid_from, $valid_to);
        return $response;
    }

    /**
     * Operation getCampaignProductsWithHttpInfo
     *
     * Collection of campaign products
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getCampaignProductsAsync
     *
     * Collection of campaign products
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignProductsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null, $display_in = null, $type_id = null, $store_id = null, $value_type_id = null, $is_valid = null, $valid_from = null, $valid_to = null)
    {
        return $this->getCampaignProductsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code, $display_in, $type_id, $store_id, $value_type_id, $is_valid, $valid_from, $valid_to)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCampaignProductsAsyncWithHttpInfo
     *
     * Collection of campaign products
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @param  string|null $display_in Place to display campaign product. (optional)
     * @param  string[]|null $type_id Type of the customer for a campaign product. (optional)
     * @param  string|null $store_id Parameter filters all campaign products from [store](#tag/Stores) by store ID. (optional)
    ...
    /**
     * Create request for operation 'getCampaignProducts'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCampaignProductsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null, $display_in = null, $type_id = null, $store_id = null, $value_type_id = null, $is_valid = null, $valid_from = null, $valid_to = null)
    {

        $resourcePath = '/campaign-products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($display_in !== null) {
            $queryParams['display_in'] = ObjectSerializer::toQueryValue($display_in, null);
        }
        // query params
        if (is_array($type_id)) {
        ...
        if ($value_type_id !== null) {
            $queryParams['value_type_id'] = ObjectSerializer::toQueryValue($value_type_id, null);
        }
        // query params
        if ($is_valid !== null) {
    ...
    {
        list($response) = $this->postCampaignProductWithHttpInfo($body, $accept_language);
        return $response;
    }

    /**
     * Operation postCampaignProductWithHttpInfo
     *
     * Create a campaign product
     *
    ...
    /**
     * Operation postCampaignProductAsync
     *
     * Create a campaign product
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\CampaignproductsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCampaignProductAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postCampaignProductAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postCampaignProductAsyncWithHttpInfo
     *
     * Create a campaign product
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\CampaignproductsBody $body (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postCampaignProductRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postCampaignProduct'
            );
        }
    ...
    /**
     * Operation postCampaignProductStoreRecord
     *
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2013
     */
    public function postCampaignProductStoreRecord($body, $campaign_product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->postCampaignProductStoreRecordWithHttpInfo($body, $campaign_product_id, $accept_language);
        return $response;
    }

    /**
     * Operation postCampaignProductStoreRecordWithHttpInfo
     *
     * Add a store to the campaign product
     *
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2013, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCampaignProductStoreRecordWithHttpInfo($body, $campaign_product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2013';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2013',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postCampaignProductStoreRecordAsync
     *
     * Add a store to the campaign product
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\CampaignProductIdCampaignproductstorerecordsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCampaignProductStoreRecordAsync($body, $campaign_product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postCampaignProductStoreRecordAsyncWithHttpInfo($body, $campaign_product_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postCampaignProductStoreRecordAsyncWithHttpInfo
     *
     * Add a store to the campaign product
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\CampaignProductIdCampaignproductstorerecordsBody $body (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postCampaignProductStoreRecordRequest($body, $campaign_product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postCampaignProductStoreRecord'
            );
        }
        // verify the required parameter 'campaign_product_id' is set
        if ($campaign_product_id === null || (is_array($campaign_product_id) && count($campaign_product_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_product_id when calling postCampaignProductStoreRecord'
            );
        }
