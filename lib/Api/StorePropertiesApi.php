...
/**
 * StorePropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class StorePropertiesApi
{
    ...
    {
        list($response) = $this->getStorePropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getStorePropertiesWithHttpInfo
     *
     * Get all store properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getStorePropertiesAsync
     *
     * Get all store properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getStorePropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getStorePropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStorePropertiesAsyncWithHttpInfo
     *
     * Get all store properties
     *
    ...
    /**
     * Create request for operation 'getStoreProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getStorePropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/store-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getStoreProperty
     *
     * Get a store property
     *
     * @param  string $store_property_id The unique ID of the store property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getStoreProperty($store_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getStorePropertyWithHttpInfo($store_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getStorePropertyWithHttpInfo
     *
     * Get a store property
     *
     * @param  string $store_property_id The unique ID of the store property. (required)
     ...
     */
    public function getStorePropertyWithHttpInfo($store_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getStorePropertyRequest($store_property_id, $accept_language);
    ...
    /**
     * Operation getStorePropertyAsync
     *
     * Get a store property
     *
     * @param  string $store_property_id The unique ID of the store property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorePropertyAsync($store_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getStorePropertyAsyncWithHttpInfo($store_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStorePropertyAsyncWithHttpInfo
     *
     * Get a store property
     *
     * @param  string $store_property_id The unique ID of the store property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorePropertyAsyncWithHttpInfo($store_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getStorePropertyRequest($store_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getStoreProperty'
     *
     * @param  string $store_property_id The unique ID of the store property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStorePropertyRequest($store_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'store_property_id' is set
        if ($store_property_id === null || (is_array($store_property_id) && count($store_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_property_id when calling getStoreProperty'
            );
        }

        $resourcePath = '/store-properties/{store_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($store_property_id !== null) {
            $resourcePath = str_replace(
                '{' . 'store_property_id' . '}',
                ObjectSerializer::toPathValue($store_property_id),
                $resourcePath
            );
        }
