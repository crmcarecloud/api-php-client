...
class PaymentTypesApi
{
     ...
     *
     * @param  string $payment_type_id The unique ID of the payment type. (required)
    ...
    {
        list($response) = $this->getPaymentTypeWithHttpInfo($payment_type_id, $accept_language);
        return $response;
    }

    /**
     * Operation getPaymentTypeWithHttpInfo
     *
     * Detail of an payment type
     *
     * @param  string $payment_type_id The unique ID of the payment type. (required)
     ...
     */
    public function getPaymentTypeAsync($payment_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getPaymentTypeAsyncWithHttpInfo($payment_type_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPaymentTypeAsyncWithHttpInfo
     *
     * Detail of an payment type
     *
     * @param  string $payment_type_id The unique ID of the payment type. (required)
    ...
    /**
     * Create request for operation 'getPaymentType'
     *
     * @param  string $payment_type_id The unique ID of the payment type. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getPaymentTypeRequest($payment_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        ...
        if ($payment_type_id === null || (is_array($payment_type_id) && count($payment_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_type_id when calling getPaymentType'
            );
        }

        $resourcePath = '/payment-types/{payment_type_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getPaymentTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getPaymentTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/payment-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
