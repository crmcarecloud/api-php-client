...
/**
 * VoucherPropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class VoucherPropertiesApi
{
    ...
    /**
     * Operation getVoucherProperties
     *
     ...
     */
    public function getVoucherProperties($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getVoucherPropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getVoucherPropertiesWithHttpInfo
     *
     * Get all voucher properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getVoucherPropertiesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200175';
        $request = $this->getVoucherPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Operation getVoucherPropertiesAsync
     *
     * Get all voucher properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getVoucherPropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getVoucherPropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVoucherPropertiesAsyncWithHttpInfo
     *
     * Get all voucher properties
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVoucherPropertiesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200175';
        $request = $this->getVoucherPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getVoucherProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getVoucherPropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/voucher-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getVoucherProperty
     *
     * Get a voucher property
     *
     * @param  string $voucher_property_id The unique ID of the voucher property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getVoucherProperty($voucher_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getVoucherPropertyWithHttpInfo($voucher_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getVoucherPropertyWithHttpInfo
     *
     * Get a voucher property
     *
     * @param  string $voucher_property_id The unique ID of the voucher property. (required)
     ...
     */
    public function getVoucherPropertyWithHttpInfo($voucher_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getVoucherPropertyRequest($voucher_property_id, $accept_language);
    ...
    /**
     * Operation getVoucherPropertyAsync
     *
     * Get a voucher property
     *
     * @param  string $voucher_property_id The unique ID of the voucher property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVoucherPropertyAsync($voucher_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getVoucherPropertyAsyncWithHttpInfo($voucher_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVoucherPropertyAsyncWithHttpInfo
     *
     * Get a voucher property
     *
     * @param  string $voucher_property_id The unique ID of the voucher property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVoucherPropertyAsyncWithHttpInfo($voucher_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getVoucherPropertyRequest($voucher_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getVoucherProperty'
     *
     * @param  string $voucher_property_id The unique ID of the voucher property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVoucherPropertyRequest($voucher_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'voucher_property_id' is set
        if ($voucher_property_id === null || (is_array($voucher_property_id) && count($voucher_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $voucher_property_id when calling getVoucherProperty'
            );
        }

        $resourcePath = '/voucher-properties/{voucher_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($voucher_property_id !== null) {
            $resourcePath = str_replace(
                '{' . 'voucher_property_id' . '}',
                ObjectSerializer::toPathValue($voucher_property_id),
                $resourcePath
            );
        }
