...
/**
 * MessageTemplatesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class MessageTemplatesApi
{
     ...
     *
     * @param  string $message_template_id The unique ID of the message template. (required)
     ...
     */
    public function getMessageTemplate($message_template_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getMessageTemplateWithHttpInfo($message_template_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getMessageTemplateWithHttpInfo($message_template_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20081';
        $request = $this->getMessageTemplateRequest($message_template_id, $accept_language);
     ...
     */
    public function getMessageTemplateAsync($message_template_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getMessageTemplateAsyncWithHttpInfo($message_template_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessageTemplateAsyncWithHttpInfo($message_template_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20081';
        $request = $this->getMessageTemplateRequest($message_template_id, $accept_language);
     ...
     */
    protected function getMessageTemplateRequest($message_template_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'message_template_id' is set
        if ($message_template_id === null || (is_array($message_template_id) && count($message_template_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $message_template_id when calling getMessageTemplate'
            );
        }

        $resourcePath = '/message-templates/{message_template_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($message_template_id !== null) {
            $resourcePath = str_replace(
                '{' . 'message_template_id' . '}',
                ObjectSerializer::toPathValue($message_template_id),
                $resourcePath
            );
        }
