...
class TestsApi
{
    ...
    /**
     * Operation getTestsConnection
     *
     * Connection test
     *
     * @param  string $test_string A test string sends to REST API. Correct result should revert the string. (optional)
     *
    ...
    {
        list($response) = $this->getTestsConnectionWithHttpInfo($test_string);
        return $response;
    }

    /**
     * Operation getTestsConnectionWithHttpInfo
     *
     * Connection test
     *
     * @param  string $test_string A test string sends to REST API. Correct result should revert the string. (optional)
    ...
    /**
     * Operation getTestsConnectionAsync
     *
     * Connection test
     *
     * @param  string $test_string A test string sends to REST API. Correct result should revert the string. (optional)
     ...
     */
    public function getTestsConnectionAsync($test_string = null)
    {
        return $this->getTestsConnectionAsyncWithHttpInfo($test_string)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTestsConnectionAsyncWithHttpInfo
     *
     * Connection test
     *
     * @param  string|null $test_string A test string sends to REST API. Correct result should revert the string. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    ...
    /**
     * Create request for operation 'getTestsConnection'
     *
     * @param  string $test_string A test string sends to REST API. Correct result should revert the string. (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getTestsConnectionRequest($test_string = null)
    {

        $resourcePath = '/tests/connection';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($test_string !== null) {
            $queryParams['test_string'] = ObjectSerializer::toQueryValue($test_string, null);
        }
