...
class CustomerRelationTypesApi
{
     ...
     * @return \CareCloud\Model\InlineResponse20036
     */
     ...
     * @throws \CareCloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CareCloud\Model\InlineResponse20036, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerRelationTypeWithHttpInfo($customer_relation_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CareCloud\Model\InlineResponse20036';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CareCloud\Model\InlineResponse20036',
     ...
     * @throws \CareCloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CareCloud\Model\InlineResponse20035
     */
     ...
     * @throws \CareCloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CareCloud\Model\InlineResponse20035, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\CareCloud\Model\InlineResponse20035';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CareCloud\Model\InlineResponse20035',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
