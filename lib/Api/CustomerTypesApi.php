...
/**
 * CustomerTypesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class CustomerTypesApi
{
    ...
    /**
     * Operation getCustomerType
     *
     * Detail of a customer type
     *
     * @param  string $customer_type_id The unique ID of a customer type in CareCloud. (required)
     ...
     */
    public function getCustomerType($customer_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getCustomerTypeWithHttpInfo($customer_type_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCustomerTypeWithHttpInfo
     *
     * Detail of a customer type
     *
     * @param  string $customer_type_id The unique ID of a customer type in CareCloud. (required)
     ...
     */
    public function getCustomerTypeWithHttpInfo($customer_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20064';
        $request = $this->getCustomerTypeRequest($customer_type_id, $accept_language);
    ...
    /**
     * Operation getCustomerTypeAsync
     *
     * Detail of a customer type
     *
     * @param  string $customer_type_id The unique ID of a customer type in CareCloud. (required)
     ...
     */
    public function getCustomerTypeAsync($customer_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCustomerTypeAsyncWithHttpInfo($customer_type_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerTypeAsyncWithHttpInfo
     *
     * Detail of a customer type
     *
     * @param  string $customer_type_id The unique ID of a customer type in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerTypeAsyncWithHttpInfo($customer_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20064';
        $request = $this->getCustomerTypeRequest($customer_type_id, $accept_language);
    ...
    /**
     * Create request for operation 'getCustomerType'
     *
     * @param  string $customer_type_id The unique ID of a customer type in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getCustomerTypeRequest($customer_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'customer_type_id' is set
        if ($customer_type_id === null || (is_array($customer_type_id) && count($customer_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_type_id when calling getCustomerType'
            );
        }

        $resourcePath = '/customer-types/{customer_type_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($customer_type_id !== null) {
            $resourcePath = str_replace(
                '{' . 'customer_type_id' . '}',
                ObjectSerializer::toPathValue($customer_type_id),
                $resourcePath
            );
        }
     ...
     */
    public function getCustomerTypes($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        list($response) = $this->getCustomerTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getCustomerTypesWithHttpInfo
     *
     * Get all customer types
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getCustomerTypesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20063';
        $request = $this->getCustomerTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Operation getCustomerTypesAsync
     *
     * Get all customer types
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getCustomerTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerTypesAsyncWithHttpInfo
     *
     * Get all customer types
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerTypesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20063';
        $request = $this->getCustomerTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Create request for operation 'getCustomerTypes'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomerTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/customer-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
