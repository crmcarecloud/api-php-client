...
/**
 * CreditHistoryApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class CreditHistoryApi
{
     ...
     * @param  string $credit_operation_type Search record by the operation type name or a part of the operation type name. (optional)
     * @param  string $credit_operation_note Search record by the operation note or a part of the operation note. (optional)
     *
    ...
    {
        list($response) = $this->getCreditHistoryWithHttpInfo($customer_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $store_id, $partner_id, $time_from, $time_to, $credit_operation_type, $credit_operation_note);
        return $response;
    }
     ...
     */
    public function getCreditHistoryAsync($customer_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $store_id = null, $partner_id = null, $time_from = null, $time_to = null, $credit_operation_type = null, $credit_operation_note = null)
    {
        return $this->getCreditHistoryAsyncWithHttpInfo($customer_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $store_id, $partner_id, $time_from, $time_to, $credit_operation_type, $credit_operation_note)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  string|null $credit_operation_type Search record by the operation type name or a part of the operation type name. (optional)
     * @param  string|null $credit_operation_note Search record by the operation note or a part of the operation note. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
     ...
     */
    protected function getCreditHistoryRequest($customer_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $store_id = null, $partner_id = null, $time_from = null, $time_to = null, $credit_operation_type = null, $credit_operation_note = null)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null || (is_array($customer_id) && count($customer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_id when calling getCreditHistory'
            );
        }
        ...
        // query params
        if ($credit_operation_type !== null) {
            $queryParams['credit_operation_type'] = ObjectSerializer::toQueryValue($credit_operation_type, null);
        }
        // query params
        if ($credit_operation_note !== null) {
            $queryParams['credit_operation_note'] = ObjectSerializer::toQueryValue($credit_operation_note, null);
        }
        // header params
