...
/**
 * CustomerEngagementApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class CustomerEngagementApi
{
    ...
    /**
     * Operation getCustomerEngagementSetup
     *
     * Get a customer engagement setup
     *
     * @param  string $customer_engagement_setup_id The unique ID of the customer engagement setup. (required)
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetSetup200Response
     */
    public function getCustomerEngagementSetup($customer_engagement_setup_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getCustomerEngagementSetupWithHttpInfo($customer_engagement_setup_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCustomerEngagementSetupWithHttpInfo
     *
     * Get a customer engagement setup
     *
     * @param  string $customer_engagement_setup_id The unique ID of the customer engagement setup. (required)
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetSetup200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerEngagementSetupWithHttpInfo($customer_engagement_setup_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetSetup200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetSetup200Response',
    ...
    /**
     * Operation getCustomerEngagementSetupAsync
     *
     * Get a customer engagement setup
     *
     * @param  string $customer_engagement_setup_id The unique ID of the customer engagement setup. (required)
     ...
     */
    public function getCustomerEngagementSetupAsync($customer_engagement_setup_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCustomerEngagementSetupAsyncWithHttpInfo($customer_engagement_setup_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerEngagementSetupAsyncWithHttpInfo
     *
     * Get a customer engagement setup
     *
     * @param  string $customer_engagement_setup_id The unique ID of the customer engagement setup. (required)
    ...
    /**
     * Create request for operation 'getCustomerEngagementSetup'
     *
     * @param  string $customer_engagement_setup_id The unique ID of the customer engagement setup. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getCustomerEngagementSetupRequest($customer_engagement_setup_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'customer_engagement_setup_id' is set
        if ($customer_engagement_setup_id === null || (is_array($customer_engagement_setup_id) && count($customer_engagement_setup_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_engagement_setup_id when calling getCustomerEngagementSetup'
            );
        }

        $resourcePath = '/customer-engagement-setups/{customer_engagement_setup_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($customer_engagement_setup_id !== null) {
            $resourcePath = str_replace(
                '{' . 'customer_engagement_setup_id' . '}',
                ObjectSerializer::toPathValue($customer_engagement_setup_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getCustomerEngagementSetups
     *
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetSetups200Response
     */
    ...
    {
        list($response) = $this->getCustomerEngagementSetupsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getCustomerEngagementSetupsWithHttpInfo
     *
     * Get all customer engagement setups
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetSetups200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetSetups200Response';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetSetups200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getCustomerEngagementSetupsAsync
     *
     * Get all customer engagement setups
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerEngagementSetupsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getCustomerEngagementSetupsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerEngagementSetupsAsyncWithHttpInfo
     *
     * Get all customer engagement setups
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Create request for operation 'getCustomerEngagementSetups'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return in API response. &lt;br/&gt;⚠️ We recommended adjust the batch size based on processing time. Depending on the response time of the request. Default value of 100 records is used if &#x60;count&#x60; parameter is not set. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. Default value of 0 is used when parameter &#x60;offset&#x60; is not set. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomerEngagementSetupsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/customer-engagement-setups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
