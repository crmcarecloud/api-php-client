...
/**
 * PartnerPropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class PartnerPropertiesApi
{
    ...
    /**
     * Operation getPartnerProperties
     *
     ...
     */
    public function getPartnerProperties($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getPartnerPropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getPartnerPropertiesWithHttpInfo
     *
     * Get all partner properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getPartnerPropertiesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20089';
        $request = $this->getPartnerPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Operation getPartnerPropertiesAsync
     *
     * Get all partner properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getPartnerPropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getPartnerPropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerPropertiesAsyncWithHttpInfo
     *
     * Get all partner properties
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerPropertiesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20089';
        $request = $this->getPartnerPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getPartnerProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getPartnerPropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/partner-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPartnerProperty
     *
     * Get a partner property
     *
     * @param  string $partner_property_id The unique ID of the partner property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getPartnerProperty($partner_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getPartnerPropertyWithHttpInfo($partner_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getPartnerPropertyWithHttpInfo
     *
     * Get a partner property
     *
     * @param  string $partner_property_id The unique ID of the partner property. (required)
     ...
     */
    public function getPartnerPropertyWithHttpInfo($partner_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getPartnerPropertyRequest($partner_property_id, $accept_language);
    ...
    /**
     * Operation getPartnerPropertyAsync
     *
     * Get a partner property
     *
     * @param  string $partner_property_id The unique ID of the partner property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerPropertyAsync($partner_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getPartnerPropertyAsyncWithHttpInfo($partner_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerPropertyAsyncWithHttpInfo
     *
     * Get a partner property
     *
     * @param  string $partner_property_id The unique ID of the partner property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerPropertyAsyncWithHttpInfo($partner_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getPartnerPropertyRequest($partner_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getPartnerProperty'
     *
     * @param  string $partner_property_id The unique ID of the partner property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerPropertyRequest($partner_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'partner_property_id' is set
        if ($partner_property_id === null || (is_array($partner_property_id) && count($partner_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $partner_property_id when calling getPartnerProperty'
            );
        }

        $resourcePath = '/partner-properties/{partner_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($partner_property_id !== null) {
            $resourcePath = str_replace(
                '{' . 'partner_property_id' . '}',
                ObjectSerializer::toPathValue($partner_property_id),
                $resourcePath
            );
        }
