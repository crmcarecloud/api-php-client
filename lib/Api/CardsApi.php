...
class CardsApi
{
    ...
    /**
     * Operation postGeneratePassMachine
     *
     * Get a PassMachine digital card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsGeneratepassmachinecardBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->postGeneratePassMachineWithHttpInfo($body, $accept_language);
        return $response;
    }

    /**
     * Operation postGeneratePassMachineWithHttpInfo
     *
     * Get a PassMachine digital card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsGeneratepassmachinecardBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation postGeneratePassMachineAsync
     *
     * Get a PassMachine digital card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsGeneratepassmachinecardBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postGeneratePassMachineAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postGeneratePassMachineAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postGeneratePassMachineAsyncWithHttpInfo
     *
     * Get a PassMachine digital card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsGeneratepassmachinecardBody $body (required)
    ...
    /**
     * Create request for operation 'postGeneratePassMachine'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsGeneratepassmachinecardBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postGeneratePassMachineRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postGeneratePassMachine'
            );
        }

        $resourcePath = '/cards/actions/generate-pass-machine-card';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postValidateIsicCard
     *
     * Validate ISIC card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsValidateisiccardBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->postValidateIsicCardWithHttpInfo($body, $accept_language);
        return $response;
    }

    /**
     * Operation postValidateIsicCardWithHttpInfo
     *
     * Validate ISIC card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsValidateisiccardBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation postValidateIsicCardAsync
     *
     * Validate ISIC card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsValidateisiccardBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postValidateIsicCardAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postValidateIsicCardAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postValidateIsicCardAsyncWithHttpInfo
     *
     * Validate ISIC card
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsValidateisiccardBody $body (required)
    ...
    /**
     * Create request for operation 'postValidateIsicCard'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsValidateisiccardBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postValidateIsicCardRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postValidateIsicCard'
            );
        }

        $resourcePath = '/cards/actions/validate-isic-card';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
