...
/**
 * BookingStatusesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class BookingStatusesApi
{
     ...
     *
     * @param  string $booking_status_id The unique ID of the booking status. (required)
     ...
     */
    public function getBookingStatus($booking_status_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getBookingStatusWithHttpInfo($booking_status_id, $accept_language);
        return $response;
    }

    /**
     * Operation getBookingStatusWithHttpInfo
     *
     * Get a booking status
     *
     * @param  string $booking_status_id The unique ID of the booking status. (required)
     ...
     */
    public function getBookingStatusWithHttpInfo($booking_status_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20010';
        $request = $this->getBookingStatusRequest($booking_status_id, $accept_language);
    ...
    /**
     * Operation getBookingStatusAsync
     *
     * Get a booking status
     *
     * @param  string $booking_status_id The unique ID of the booking status. (required)
     ...
     */
    public function getBookingStatusAsync($booking_status_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getBookingStatusAsyncWithHttpInfo($booking_status_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBookingStatusAsyncWithHttpInfo
     *
     * Get a booking status
     *
     * @param  string $booking_status_id The unique ID of the booking status. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookingStatusAsyncWithHttpInfo($booking_status_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20010';
        $request = $this->getBookingStatusRequest($booking_status_id, $accept_language);
    ...
    /**
     * Create request for operation 'getBookingStatus'
     *
     * @param  string $booking_status_id The unique ID of the booking status. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getBookingStatusRequest($booking_status_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'booking_status_id' is set
        if ($booking_status_id === null || (is_array($booking_status_id) && count($booking_status_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $booking_status_id when calling getBookingStatus'
            );
        }

        $resourcePath = '/booking-statuses/{booking_status_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($booking_status_id !== null) {
            $resourcePath = str_replace(
                '{' . 'booking_status_id' . '}',
                ObjectSerializer::toPathValue($booking_status_id),
                $resourcePath
            );
        }
     ...
     */
    public function getBookingStatuses($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        list($response) = $this->getBookingStatusesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getBookingStatusesWithHttpInfo
     *
     * Get all booking statuses
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getBookingStatusesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2009';
        $request = $this->getBookingStatusesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Operation getBookingStatusesAsync
     *
     * Get all booking statuses
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookingStatusesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getBookingStatusesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBookingStatusesAsyncWithHttpInfo
     *
     * Get all booking statuses
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBookingStatusesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2009';
        $request = $this->getBookingStatusesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Create request for operation 'getBookingStatuses'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBookingStatusesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/booking-statuses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
