...
class TargetGroupsApi
{
     ...
     * Get a target group
     *
     * @param  string $target_group_id The unique ID of the target group. (required)
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroup200Response
     */
    public function getTargetGroup($target_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getTargetGroupWithHttpInfo($target_group_id, $accept_language);
        return $response;
    }

    /**
     * Operation getTargetGroupWithHttpInfo
     *
     * Get a target group
     *
     * @param  string $target_group_id The unique ID of the target group. (required)
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroup200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTargetGroupWithHttpInfo($target_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroup200Response';
        $request = $this->getTargetGroupRequest($target_group_id, $accept_language);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroup200Response',
     ...
     */
    public function getTargetGroupAsync($target_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getTargetGroupAsyncWithHttpInfo($target_group_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTargetGroupAsyncWithHttpInfo
     *
     * Get a target group
     *
     * @param  string $target_group_id The unique ID of the target group. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTargetGroupAsyncWithHttpInfo($target_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroup200Response';
        $request = $this->getTargetGroupRequest($target_group_id, $accept_language);
    ...
    /**
     * Create request for operation 'getTargetGroup'
     *
     * @param  string $target_group_id The unique ID of the target group. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getTargetGroupRequest($target_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        ...
        if ($target_group_id === null || (is_array($target_group_id) && count($target_group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $target_group_id when calling getTargetGroup'
            );
        }

        $resourcePath = '/target-groups/{target_group_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroups200Response
     */
    public function getTargetGroups($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $communication_channel_id = null)
    {
        list($response) = $this->getTargetGroupsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $communication_channel_id);
        return $response;
    }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroups200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTargetGroupsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $communication_channel_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroups200Response';
        $request = $this->getTargetGroupsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $communication_channel_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroups200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTargetGroupsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $communication_channel_id = null)
    {
        return $this->getTargetGroupsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $communication_channel_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTargetGroupsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $communication_channel_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetTargetGroups200Response';
        $request = $this->getTargetGroupsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $communication_channel_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTargetGroupsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $communication_channel_id = null)
    {

        $resourcePath = '/target-groups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
