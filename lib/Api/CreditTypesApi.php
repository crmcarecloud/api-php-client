...
/**
 * CreditTypesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class CreditTypesApi
{
    ...
    /**
     * Operation getCreditType
     *
     * Get a credit type
     *
     * @param  string $credit_type_id The unique ID of a credit type. (required)
    ...
    {
        list($response) = $this->getCreditTypeWithHttpInfo($credit_type_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCreditTypeWithHttpInfo
     *
     * Get a credit type
     *
     * @param  string $credit_type_id The unique ID of a credit type. (required)
     ...
     */
    public function getCreditTypeAsync($credit_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCreditTypeAsyncWithHttpInfo($credit_type_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCreditTypeAsyncWithHttpInfo
     *
     * Get a credit type
     *
     * @param  string $credit_type_id The unique ID of a credit type. (required)
    ...
    /**
     * Create request for operation 'getCreditType'
     *
     * @param  string $credit_type_id The unique ID of a credit type. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getCreditTypeRequest($credit_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'credit_type_id' is set
        if ($credit_type_id === null || (is_array($credit_type_id) && count($credit_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $credit_type_id when calling getCreditType'
            );
        }

        $resourcePath = '/credit-types/{credit_type_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($credit_type_id !== null) {
            $resourcePath = str_replace(
                '{' . 'credit_type_id' . '}',
                ObjectSerializer::toPathValue($credit_type_id),
                $resourcePath
            );
        }
    ...
    {
        list($response) = $this->getCreditTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getCreditTypesWithHttpInfo
     *
     * Get all credit types
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCreditTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getCreditTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCreditTypesAsyncWithHttpInfo
     *
     * Get all credit types
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Create request for operation 'getCreditTypes'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCreditTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/credit-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
