...
/**
 * ProductPropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class ProductPropertiesApi
{
    ...
    /**
     * Operation getProductProperties
     *
     ...
     */
    public function getProductProperties($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getProductPropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getProductPropertiesWithHttpInfo
     *
     * Get all product properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getProductPropertiesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200104';
        $request = $this->getProductPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Operation getProductPropertiesAsync
     *
     * Get all product properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getProductPropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getProductPropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductPropertiesAsyncWithHttpInfo
     *
     * Get all product properties
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductPropertiesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200104';
        $request = $this->getProductPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getProductProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getProductPropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/product-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getProductProperty
     *
     * Get a product property
     *
     * @param  string $product_property_id The unique ID of the product property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getProductProperty($product_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getProductPropertyWithHttpInfo($product_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getProductPropertyWithHttpInfo
     *
     * Get a product property
     *
     * @param  string $product_property_id The unique ID of the product property. (required)
     ...
     */
    public function getProductPropertyWithHttpInfo($product_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getProductPropertyRequest($product_property_id, $accept_language);
    ...
    /**
     * Operation getProductPropertyAsync
     *
     * Get a product property
     *
     * @param  string $product_property_id The unique ID of the product property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductPropertyAsync($product_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getProductPropertyAsyncWithHttpInfo($product_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductPropertyAsyncWithHttpInfo
     *
     * Get a product property
     *
     * @param  string $product_property_id The unique ID of the product property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductPropertyAsyncWithHttpInfo($product_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getProductPropertyRequest($product_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getProductProperty'
     *
     * @param  string $product_property_id The unique ID of the product property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductPropertyRequest($product_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'product_property_id' is set
        if ($product_property_id === null || (is_array($product_property_id) && count($product_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product_property_id when calling getProductProperty'
            );
        }

        $resourcePath = '/product-properties/{product_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($product_property_id !== null) {
            $resourcePath = str_replace(
                '{' . 'product_property_id' . '}',
                ObjectSerializer::toPathValue($product_property_id),
                $resourcePath
            );
        }
