...
class StoresApi
{
    ...
    /**
     * Operation deleteSubStoreProperty
     *
     * Delete a property record of the store
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     * @return void
     */
    public function deleteSubStoreProperty($store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->deleteSubStorePropertyWithHttpInfo($store_id, $property_record_id, $accept_language);
    }

    /**
     * Operation deleteSubStorePropertyWithHttpInfo
     *
     * Delete a property record of the store
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     */
    public function deleteSubStorePropertyWithHttpInfo($store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->deleteSubStorePropertyRequest($store_id, $property_record_id, $accept_language);
    ...
    /**
     * Operation deleteSubStorePropertyAsync
     *
     * Delete a property record of the store
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     */
    public function deleteSubStorePropertyAsync($store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->deleteSubStorePropertyAsyncWithHttpInfo($store_id, $property_record_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteSubStorePropertyAsyncWithHttpInfo
     *
     * Delete a property record of the store
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSubStorePropertyAsyncWithHttpInfo($store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->deleteSubStorePropertyRequest($store_id, $property_record_id, $accept_language);
    ...
    /**
     * Create request for operation 'deleteSubStoreProperty'
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $property_record_id The unique ID of the property record. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    protected function deleteSubStorePropertyRequest($store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling deleteSubStoreProperty'
            );
        }
        ...
        if ($property_record_id === null || (is_array($property_record_id) && count($property_record_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_record_id when calling deleteSubStoreProperty'
            );
        }

        $resourcePath = '/stores/{store_id}/property-records/{property_record_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getStore($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getStoreWithHttpInfo($store_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getStoreWithHttpInfo($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200145';
        $request = $this->getStoreRequest($store_id, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoreAsync($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getStoreAsyncWithHttpInfo($store_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoreAsyncWithHttpInfo($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200145';
        $request = $this->getStoreRequest($store_id, $accept_language);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStoreRequest($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $property_id Store property ID from resource [store-properties](#tag/Store-properties). The parameter determines property, which is used to filter stores by their properties. The parameter must be used in combination with property_value otherwise is ignored in the request. (optional)
     * @param  string $property_value Store property record value from resource [/stores/{store_id}/property-records](#operation/getSubStoreProperties) or [store-properties](#tag/Store-properties) in case of datatype with multiple values. Parameter filters stores depends of store property record value. The parameter must be used in combination with property_id otherwise is ignored in the request. (optional)
     * @param  string $system_id The unique ID of the store in external system (e-shop, POS, etc.) (optional)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200144
     */
    public function getStores($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $visible_for_customer = null, $property_id = null, $property_value = null, $system_id = null)
    {
        list($response) = $this->getStoresWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $visible_for_customer, $property_id, $property_value, $system_id);
        return $response;
    }
     ...
     */
    public function getStoresWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $visible_for_customer = null, $property_id = null, $property_value = null, $system_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200144';
        $request = $this->getStoresRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $visible_for_customer, $property_id, $property_value, $system_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoresAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $visible_for_customer = null, $property_id = null, $property_value = null, $system_id = null)
    {
        return $this->getStoresAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $visible_for_customer, $property_id, $property_value, $system_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  string|null $property_id Store property ID from resource [store-properties](#tag/Store-properties). The parameter determines property, which is used to filter stores by their properties. The parameter must be used in combination with property_value otherwise is ignored in the request. (optional)
     * @param  string|null $property_value Store property record value from resource [/stores/{store_id}/property-records](#operation/getSubStoreProperties) or [store-properties](#tag/Store-properties) in case of datatype with multiple values. Parameter filters stores depends of store property record value. The parameter must be used in combination with property_id otherwise is ignored in the request. (optional)
     * @param  string|null $system_id The unique ID of the store in external system (e-shop, POS, etc.) (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoresAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $visible_for_customer = null, $property_id = null, $property_value = null, $system_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200144';
        $request = $this->getStoresRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $visible_for_customer, $property_id, $property_value, $system_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStoresRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $visible_for_customer = null, $property_id = null, $property_value = null, $system_id = null)
    {
        ...
        // query params
        if ($property_id !== null) {
            $queryParams['property_id'] = ObjectSerializer::toQueryValue($property_id, null);
        }
        // query params
        if ($property_value !== null) {
            $queryParams['property_value'] = ObjectSerializer::toQueryValue($property_value, null);
        }
        // query params
        if ($system_id !== null) {
            $queryParams['system_id'] = ObjectSerializer::toQueryValue($system_id, null);
        }
        // header params
        if ($accept_language !== null) {
            $headerParams['Accept-Language'] = ObjectSerializer::toHeaderValue($accept_language);
     ...
     */
    public function getSubStoreGroups($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getSubStoreGroupsWithHttpInfo($store_id, $accept_language);
        return $response;
    }

    /**
     * Operation getSubStoreGroupsWithHttpInfo
     *
     * Get a collection of store group records
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     */
    public function getSubStoreGroupsWithHttpInfo($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200147';
        $request = $this->getSubStoreGroupsRequest($store_id, $accept_language);
    ...
    /**
     * Operation getSubStoreGroupsAsync
     *
     * Get a collection of store group records
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubStoreGroupsAsync($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSubStoreGroupsAsyncWithHttpInfo($store_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSubStoreGroupsAsyncWithHttpInfo
     *
     * Get a collection of store group records
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubStoreGroupsAsyncWithHttpInfo($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200147';
        $request = $this->getSubStoreGroupsRequest($store_id, $accept_language);
    ...
    /**
     * Create request for operation 'getSubStoreGroups'
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubStoreGroupsRequest($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling getSubStoreGroups'
            );
        }

        $resourcePath = '/stores/{store_id}/store-group-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getSubStoreProperties
     *
     ...
     */
    public function getSubStoreProperties($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getSubStorePropertiesWithHttpInfo($store_id, $accept_language);
        return $response;
    }

    /**
     * Operation getSubStorePropertiesWithHttpInfo
     *
     * Get a collection of properties
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     */
    public function getSubStorePropertiesWithHttpInfo($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200146';
        $request = $this->getSubStorePropertiesRequest($store_id, $accept_language);
    ...
    /**
     * Operation getSubStorePropertiesAsync
     *
     * Get a collection of properties
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubStorePropertiesAsync($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSubStorePropertiesAsyncWithHttpInfo($store_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSubStorePropertiesAsyncWithHttpInfo
     *
     * Get a collection of properties
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubStorePropertiesAsyncWithHttpInfo($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200146';
        $request = $this->getSubStorePropertiesRequest($store_id, $accept_language);
    ...
    /**
     * Create request for operation 'getSubStoreProperties'
     *
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubStorePropertiesRequest($store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling getSubStoreProperties'
            );
        }

        $resourcePath = '/stores/{store_id}/property-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Create a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoresBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postStore($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->postStoreWithHttpInfo($body, $accept_language);
        return $response;
    }
     ...
     * Create a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoresBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postStoreWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20119';
        $request = $this->postStoreRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postStoreAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postStoreAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postStoreAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20119';
        $request = $this->postStoreRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postStoreRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postStore'
            );
        }
    ...
    /**
     * Operation postSubStoreProperties
     *
     * Add a property to a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoreIdPropertyrecordsBody $body body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     */
    public function postSubStoreProperties($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->postSubStorePropertiesWithHttpInfo($body, $store_id, $accept_language);
        return $response;
    }

    /**
     * Operation postSubStorePropertiesWithHttpInfo
     *
     * Add a property to a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoreIdPropertyrecordsBody $body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     */
    public function postSubStorePropertiesWithHttpInfo($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20120';
        $request = $this->postSubStorePropertiesRequest($body, $store_id, $accept_language);
    ...
    /**
     * Operation postSubStorePropertiesAsync
     *
     * Add a property to a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoreIdPropertyrecordsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSubStorePropertiesAsync($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postSubStorePropertiesAsyncWithHttpInfo($body, $store_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postSubStorePropertiesAsyncWithHttpInfo
     *
     * Add a property to a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoreIdPropertyrecordsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSubStorePropertiesAsyncWithHttpInfo($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20120';
        $request = $this->postSubStorePropertiesRequest($body, $store_id, $accept_language);
    ...
    /**
     * Create request for operation 'postSubStoreProperties'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoreIdPropertyrecordsBody $body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postSubStorePropertiesRequest($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postSubStoreProperties'
            );
        }
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling postSubStoreProperties'
            );
        }
     ...
     * Update a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoresStoreIdBody $body body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     * @return void
     */
    public function putStore($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->putStoreWithHttpInfo($body, $store_id, $accept_language);
    }

    /**
     * Operation putStoreWithHttpInfo
     *
     * Update a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoresStoreIdBody $body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putStoreWithHttpInfo($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->putStoreRequest($body, $store_id, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putStoreAsync($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->putStoreAsyncWithHttpInfo($body, $store_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putStoreAsyncWithHttpInfo
     *
     * Update a store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoresStoreIdBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putStoreAsyncWithHttpInfo($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->putStoreRequest($body, $store_id, $accept_language);
    ...
    /**
     * Create request for operation 'putStore'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\StoresStoreIdBody $body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putStoreRequest($body, $store_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putStore'
            );
        }
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling putStore'
            );
        }
    ...
    /**
     * Operation putSubStoreProperty
     *
     * Update a property record of the store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\PropertyrecordsPropertyRecordIdBody1 $body body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $property_record_id The unique ID of the property record. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return void
     */
    public function putSubStoreProperty($body, $store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->putSubStorePropertyWithHttpInfo($body, $store_id, $property_record_id, $accept_language);
    }

    /**
     * Operation putSubStorePropertyWithHttpInfo
     *
     * Update a property record of the store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\PropertyrecordsPropertyRecordIdBody1 $body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $property_record_id The unique ID of the property record. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putSubStorePropertyWithHttpInfo($body, $store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->putSubStorePropertyRequest($body, $store_id, $property_record_id, $accept_language);
    ...
    /**
     * Operation putSubStorePropertyAsync
     *
     * Update a property record of the store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\PropertyrecordsPropertyRecordIdBody1 $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSubStorePropertyAsync($body, $store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->putSubStorePropertyAsyncWithHttpInfo($body, $store_id, $property_record_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putSubStorePropertyAsyncWithHttpInfo
     *
     * Update a property record of the store
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\PropertyrecordsPropertyRecordIdBody1 $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSubStorePropertyAsyncWithHttpInfo($body, $store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->putSubStorePropertyRequest($body, $store_id, $property_record_id, $accept_language);
    ...
    /**
     * Create request for operation 'putSubStoreProperty'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\PropertyrecordsPropertyRecordIdBody1 $body (required)
     * @param  string $store_id The unique ID of the store in CareCloud. (required)
     * @param  string $property_record_id The unique ID of the property record. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putSubStorePropertyRequest($body, $store_id, $property_record_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putSubStoreProperty'
            );
        }
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling putSubStoreProperty'
            );
        }
        // verify the required parameter 'property_record_id' is set
        if ($property_record_id === null || (is_array($property_record_id) && count($property_record_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_record_id when calling putSubStoreProperty'
            );
        }
