...
/**
 * PointTypesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class PointTypesApi
{
    ...
    /**
     * Operation getPointType
     *
     * Get a point type
     *
     * @param  string $point_type_id The unique ID of a point type. (required)
     ...
     */
    public function getPointType($point_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getPointTypeWithHttpInfo($point_type_id, $accept_language);
        return $response;
    }

    /**
     * Operation getPointTypeWithHttpInfo
     *
     * Get a point type
     *
     * @param  string $point_type_id The unique ID of a point type. (required)
     ...
     */
    public function getPointTypeWithHttpInfo($point_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20097';
        $request = $this->getPointTypeRequest($point_type_id, $accept_language);
     ...
     */
    public function getPointTypeAsync($point_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getPointTypeAsyncWithHttpInfo($point_type_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPointTypeAsyncWithHttpInfo
     *
     * Get a point type
     *
     * @param  string $point_type_id The unique ID of a point type. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPointTypeAsyncWithHttpInfo($point_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20097';
        $request = $this->getPointTypeRequest($point_type_id, $accept_language);
    ...
    /**
     * Create request for operation 'getPointType'
     *
     * @param  string $point_type_id The unique ID of a point type. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getPointTypeRequest($point_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'point_type_id' is set
        if ($point_type_id === null || (is_array($point_type_id) && count($point_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $point_type_id when calling getPointType'
            );
        }

        $resourcePath = '/point-types/{point_type_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($point_type_id !== null) {
            $resourcePath = str_replace(
                '{' . 'point_type_id' . '}',
                ObjectSerializer::toPathValue($point_type_id),
                $resourcePath
            );
        }
     ...
     */
    public function getPointsTypes($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        list($response) = $this->getPointsTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getPointsTypesWithHttpInfo
     *
     * Get all point types
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getPointsTypesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20096';
        $request = $this->getPointsTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPointsTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getPointsTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPointsTypesAsyncWithHttpInfo
     *
     * Get all point types
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPointsTypesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20096';
        $request = $this->getPointsTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Create request for operation 'getPointsTypes'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPointsTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/point-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
