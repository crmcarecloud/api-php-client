...
/**
 * RewardPropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class RewardPropertiesApi
{
     ...
     */
    public function getRewardProperties($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getRewardPropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getRewardPropertiesWithHttpInfo
     *
     * Get all reward properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getRewardPropertiesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200132';
        $request = $this->getRewardPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Operation getRewardPropertiesAsync
     *
     * Get all reward properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getRewardPropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getRewardPropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRewardPropertiesAsyncWithHttpInfo
     *
     * Get all reward properties
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRewardPropertiesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200132';
        $request = $this->getRewardPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getRewardProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getRewardPropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/reward-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getRewardProperty
     *
     * Get a reward property
     *
     * @param  string $reward_property_id The unique ID of the reward property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getRewardProperty($reward_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getRewardPropertyWithHttpInfo($reward_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getRewardPropertyWithHttpInfo
     *
     * Get a reward property
     *
     * @param  string $reward_property_id The unique ID of the reward property. (required)
     ...
     */
    public function getRewardPropertyWithHttpInfo($reward_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getRewardPropertyRequest($reward_property_id, $accept_language);
    ...
    /**
     * Operation getRewardPropertyAsync
     *
     * Get a reward property
     *
     * @param  string $reward_property_id The unique ID of the reward property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRewardPropertyAsync($reward_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getRewardPropertyAsyncWithHttpInfo($reward_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRewardPropertyAsyncWithHttpInfo
     *
     * Get a reward property
     *
     * @param  string $reward_property_id The unique ID of the reward property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRewardPropertyAsyncWithHttpInfo($reward_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getRewardPropertyRequest($reward_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getRewardProperty'
     *
     * @param  string $reward_property_id The unique ID of the reward property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRewardPropertyRequest($reward_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'reward_property_id' is set
        if ($reward_property_id === null || (is_array($reward_property_id) && count($reward_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reward_property_id when calling getRewardProperty'
            );
        }

        $resourcePath = '/reward-properties/{reward_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($reward_property_id !== null) {
            $resourcePath = str_replace(
                '{' . 'reward_property_id' . '}',
                ObjectSerializer::toPathValue($reward_property_id),
                $resourcePath
            );
        }
