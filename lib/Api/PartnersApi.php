...
class PartnersApi
{
     ...
     * Get a partner
     *
     * @param  string $partner_id The unique ID of the partner. (required)
    ...
    {
        list($response) = $this->getPartnerWithHttpInfo($partner_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getPartnerAsync($partner_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getPartnerAsyncWithHttpInfo($partner_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getPartnerRequest($partner_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'partner_id' is set
        if ($partner_id === null || (is_array($partner_id) && count($partner_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $partner_id when calling getPartner'
            );
        }
    ...
    {
        list($response) = $this->getPartnersWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnersAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getPartnersAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnersRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
    ...
    /**
     * Operation getSubPartnerProperties
     *
    ...
    {
        list($response) = $this->getSubPartnerPropertiesWithHttpInfo($partner_id, $accept_language);
        return $response;
    }

    /**
     * Operation getSubPartnerPropertiesWithHttpInfo
     *
     * Get a collection of property records
     *
     * @param  string $partner_id The unique ID of the partner. (required)
    ...
    /**
     * Operation getSubPartnerPropertiesAsync
     *
     * Get a collection of property records
     *
     * @param  string $partner_id The unique ID of the partner. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubPartnerPropertiesAsync($partner_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSubPartnerPropertiesAsyncWithHttpInfo($partner_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSubPartnerPropertiesAsyncWithHttpInfo
     *
     * Get a collection of property records
     *
     * @param  string $partner_id The unique ID of the partner. (required)
    ...
    /**
     * Create request for operation 'getSubPartnerProperties'
     *
     * @param  string $partner_id The unique ID of the partner. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubPartnerPropertiesRequest($partner_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'partner_id' is set
        if ($partner_id === null || (is_array($partner_id) && count($partner_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $partner_id when calling getSubPartnerProperties'
            );
        }

        $resourcePath = '/partners/{partner_id}/property-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
