...
class RewardTypesApi
{
    ...
    {
        list($response) = $this->getRewardTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }
     ...
     */
    public function getRewardTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getRewardTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getRewardTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
    ...
    /**
     * Operation getRewardtype
     *
     * Get a reward type
     *
     * @param  string $reward_type_id The unique ID of the reward. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->getRewardtypeWithHttpInfo($reward_type_id, $accept_language);
        return $response;
    }

    /**
     * Operation getRewardtypeWithHttpInfo
     *
     * Get a reward type
     *
     * @param  string $reward_type_id The unique ID of the reward. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRewardtypeAsync($reward_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getRewardtypeAsyncWithHttpInfo($reward_type_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRewardtypeAsyncWithHttpInfo
     *
     * Get a reward type
     *
     * @param  string $reward_type_id The unique ID of the reward. (required)
    ...
    /**
     * Create request for operation 'getRewardtype'
     *
     * @param  string $reward_type_id The unique ID of the reward. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRewardtypeRequest($reward_type_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'reward_type_id' is set
        if ($reward_type_id === null || (is_array($reward_type_id) && count($reward_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reward_type_id when calling getRewardtype'
            );
        }

        $resourcePath = '/reward-types/{reward_type_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($reward_type_id !== null) {
            $resourcePath = str_replace(
                '{' . 'reward_type_id' . '}',
                ObjectSerializer::toPathValue($reward_type_id),
                $resourcePath
            );
        }
