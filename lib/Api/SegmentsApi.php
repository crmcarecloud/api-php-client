...
class SegmentsApi
{
     ...
     * Get a segment
     *
     * @param  string $segment_id The unique ID of the segment. (required)
    ...
    {
        list($response) = $this->getSegmentWithHttpInfo($segment_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getSegmentAsync($segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSegmentAsyncWithHttpInfo($segment_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getSegmentRequest($segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
    ...
    /**
     * Operation getSegmentGroup
     *
     * Get a segment group
     *
     * @param  string $segment_group_id The unique ID of the segment group. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getSegmentGroup($segment_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getSegmentGroupWithHttpInfo($segment_group_id, $accept_language);
        return $response;
    }

    /**
     * Operation getSegmentGroupWithHttpInfo
     *
     * Get a segment group
     *
     * @param  string $segment_group_id The unique ID of the segment group. (required)
     ...
     */
    public function getSegmentGroupWithHttpInfo($segment_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200138';
        $request = $this->getSegmentGroupRequest($segment_group_id, $accept_language);
    ...
    /**
     * Operation getSegmentGroupAsync
     *
     * Get a segment group
     *
     * @param  string $segment_group_id The unique ID of the segment group. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentGroupAsync($segment_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSegmentGroupAsyncWithHttpInfo($segment_group_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSegmentGroupAsyncWithHttpInfo
     *
     * Get a segment group
     *
     * @param  string $segment_group_id The unique ID of the segment group. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentGroupAsyncWithHttpInfo($segment_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200138';
        $request = $this->getSegmentGroupRequest($segment_group_id, $accept_language);
    ...
    /**
     * Create request for operation 'getSegmentGroup'
     *
     * @param  string $segment_group_id The unique ID of the segment group. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSegmentGroupRequest($segment_group_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'segment_group_id' is set
        if ($segment_group_id === null || (is_array($segment_group_id) && count($segment_group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $segment_group_id when calling getSegmentGroup'
            );
        }

        $resourcePath = '/segment-groups/{segment_group_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($segment_group_id !== null) {
            $resourcePath = str_replace(
                '{' . 'segment_group_id' . '}',
                ObjectSerializer::toPathValue($segment_group_id),
                $resourcePath
            );
        }
     ...
     * @param  string $name Name of the segment group. (optional)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200137
     */
    public function getSegmentGroups($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getSegmentGroupsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getSegmentGroupsWithHttpInfo
     *
     * Get all segment groups
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getSegmentGroupsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200137';
        $request = $this->getSegmentGroupsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Operation getSegmentGroupsAsync
     *
     * Get all segment groups
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentGroupsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getSegmentGroupsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSegmentGroupsAsyncWithHttpInfo
     *
     * Get all segment groups
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @param  string|null $name Name of the segment group. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentGroupsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200137';
        $request = $this->getSegmentGroupsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getSegmentGroups'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSegmentGroupsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/segment-groups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getSegments($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $segment_group_ids = null)
    {
        list($response) = $this->getSegmentsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $segment_group_ids);
        return $response;
    }
     ...
     */
    public function getSegmentsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $segment_group_ids = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200135';
        $request = $this->getSegmentsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $segment_group_ids);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $segment_group_ids = null)
    {
        return $this->getSegmentsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $segment_group_ids)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $segment_group_ids = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200135';
        $request = $this->getSegmentsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $segment_group_ids);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSegmentsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $segment_group_ids = null)
    {
    ...
    /**
     * Operation getSubSegmentRecords
     *
    ...
    {
        list($response) = $this->getSubSegmentRecordsWithHttpInfo($segment_id, $accept_language);
        return $response;
    }

    /**
     * Operation getSubSegmentRecordsWithHttpInfo
     *
     * Get a collection of segment records
     *
     * @param  string $segment_id The unique ID of the segment. (required)
    ...
    /**
     * Operation getSubSegmentRecordsAsync
     *
     * Get a collection of segment records
     *
     * @param  string $segment_id The unique ID of the segment. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubSegmentRecordsAsync($segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSubSegmentRecordsAsyncWithHttpInfo($segment_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSubSegmentRecordsAsyncWithHttpInfo
     *
     * Get a collection of segment records
     *
     * @param  string $segment_id The unique ID of the segment. (required)
    ...
    /**
     * Create request for operation 'getSubSegmentRecords'
     *
     * @param  string $segment_id The unique ID of the segment. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubSegmentRecordsRequest($segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'segment_id' is set
        if ($segment_id === null || (is_array($segment_id) && count($segment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $segment_id when calling getSubSegmentRecords'
            );
        }

        $resourcePath = '/segments/{segment_id}/segment-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postSegmentAddCustomer
     *
     * Add customer to a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsAddcustomerBody $body body (required)
     * @param  string $segment_id The unique ID of the segment. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     * @return void
     */
    public function postSegmentAddCustomer($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->postSegmentAddCustomerWithHttpInfo($body, $segment_id, $accept_language);
    }

    /**
     * Operation postSegmentAddCustomerWithHttpInfo
     *
     * Add customer to a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsAddcustomerBody $body (required)
     * @param  string $segment_id The unique ID of the segment. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     */
    public function postSegmentAddCustomerWithHttpInfo($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postSegmentAddCustomerRequest($body, $segment_id, $accept_language);
    ...
    /**
     * Operation postSegmentAddCustomerAsync
     *
     * Add customer to a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsAddcustomerBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSegmentAddCustomerAsync($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postSegmentAddCustomerAsyncWithHttpInfo($body, $segment_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postSegmentAddCustomerAsyncWithHttpInfo
     *
     * Add customer to a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsAddcustomerBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSegmentAddCustomerAsyncWithHttpInfo($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postSegmentAddCustomerRequest($body, $segment_id, $accept_language);
    ...
    /**
     * Create request for operation 'postSegmentAddCustomer'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsAddcustomerBody $body (required)
     * @param  string $segment_id The unique ID of the segment. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postSegmentAddCustomerRequest($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postSegmentAddCustomer'
            );
        }
        // verify the required parameter 'segment_id' is set
        if ($segment_id === null || (is_array($segment_id) && count($segment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $segment_id when calling postSegmentAddCustomer'
            );
        }

        $resourcePath = '/segments/{segment_id}/actions/add-customer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postSegmentRemoveCustomer
     *
     * Remove customer from a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsRemovecustomerBody $body body (required)
     * @param  string $segment_id The unique ID of the segment. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     * @return void
     */
    public function postSegmentRemoveCustomer($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->postSegmentRemoveCustomerWithHttpInfo($body, $segment_id, $accept_language);
    }

    /**
     * Operation postSegmentRemoveCustomerWithHttpInfo
     *
     * Remove customer from a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsRemovecustomerBody $body (required)
     * @param  string $segment_id The unique ID of the segment. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSegmentRemoveCustomerWithHttpInfo($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postSegmentRemoveCustomerRequest($body, $segment_id, $accept_language);
    ...
    /**
     * Operation postSegmentRemoveCustomerAsync
     *
     * Remove customer from a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsRemovecustomerBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSegmentRemoveCustomerAsync($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postSegmentRemoveCustomerAsyncWithHttpInfo($body, $segment_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postSegmentRemoveCustomerAsyncWithHttpInfo
     *
     * Remove customer from a segment
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsRemovecustomerBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSegmentRemoveCustomerAsyncWithHttpInfo($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postSegmentRemoveCustomerRequest($body, $segment_id, $accept_language);
    ...
    /**
     * Create request for operation 'postSegmentRemoveCustomer'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsRemovecustomerBody $body (required)
     * @param  string $segment_id The unique ID of the segment. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postSegmentRemoveCustomerRequest($body, $segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postSegmentRemoveCustomer'
            );
        }
        // verify the required parameter 'segment_id' is set
        if ($segment_id === null || (is_array($segment_id) && count($segment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $segment_id when calling postSegmentRemoveCustomer'
            );
        }

        $resourcePath = '/segments/{segment_id}/actions/remove-customer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
