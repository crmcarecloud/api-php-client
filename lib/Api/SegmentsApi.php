...
class SegmentsApi
{
     ...
     * Get a segment
     *
     * @param  string $segment_id The unique id for the segment (required)
     ...
     * @return \CareCloud\Model\InlineResponse20094
     */
     ...
     * @throws \CareCloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CareCloud\Model\InlineResponse20094, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSegmentWithHttpInfo($segment_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CareCloud\Model\InlineResponse20094';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CareCloud\Model\InlineResponse20094',
    ...
    {
        list($response) = $this->getSegmentsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getSegmentsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSegmentsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
     ...
     *
     * @param  \CareCloud\Model\ActionsAddcustomerBody $body body (required)
     * @param  string $segment_id The unique id for the segment (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CareCloud\ApiException on non-2xx response
     ...
     * Add customer to a segment
     *
     * @param  \CareCloud\Model\ActionsAddcustomerBody $body (required)
     * @param  string $segment_id The unique id for the segment (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CareCloud\ApiException on non-2xx response
     ...
     *
     * @param  \CareCloud\Model\ActionsRemovecustomerBody $body body (required)
     * @param  string $segment_id The unique id for the segment (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CareCloud\ApiException on non-2xx response
     ...
     * Remove customer from a segment
     *
     * @param  \CareCloud\Model\ActionsRemovecustomerBody $body (required)
     * @param  string $segment_id The unique id for the segment (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CareCloud\ApiException on non-2xx response
