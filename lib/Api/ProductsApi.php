...
class ProductsApi
{
    ...
    {
        list($response) = $this->getProductWithHttpInfo($product_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getProductAsync($product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getProductAsyncWithHttpInfo($product_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getProductRequest($product_id, $accept_language = 'cs, en-gb;q=0.8')
    {
     ...
     * @param  string $external_type_code Every product can have more than one external ID depends of the business requirements. This parameter allows to pick from witch list of external IDs you want to choose. For the list of external type codes please contact you account manager. If the parameter is not set, API uses as a default value GLOBAL. (optional, default to GLOBAL)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20098
     */
    public function getProducts($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null, $external_id = null, $external_type_code = 'GLOBAL')
    {
        list($response) = $this->getProductsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code, $external_id, $external_type_code);
        return $response;
    }
     ...
     */
    public function getProductsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null, $external_id = null, $external_type_code = 'GLOBAL')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null, $external_id = null, $external_type_code = 'GLOBAL')
    {
        return $this->getProductsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code, $external_id, $external_type_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null, $external_id = null, $external_type_code = 'GLOBAL')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20098';
        $request = $this->getProductsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code, $external_id, $external_type_code);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null, $external_id = null, $external_type_code = 'GLOBAL')
    {
        ...
        if ($external_type_code !== null) {
            $queryParams['external_type_code'] = ObjectSerializer::toQueryValue($external_type_code, null);
        }
        // header params
        if ($accept_language !== null) {
            $headerParams['Accept-Language'] = ObjectSerializer::toHeaderValue($accept_language);
     ...
     * @return void
     */
    public function postBulkProducts($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->postBulkProductsWithHttpInfo($body, $accept_language);
    }
     ...
     */
    public function postBulkProductsWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postBulkProductsRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postBulkProductsAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postBulkProductsAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postBulkProductsAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postBulkProductsRequest($body, $accept_language);
    ...
    /**
     * Create request for operation 'postBulkProducts'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ProductsBatchBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postBulkProductsRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postBulkProducts'
            );
        }
