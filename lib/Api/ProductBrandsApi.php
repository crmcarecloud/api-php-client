...
class ProductBrandsApi
{
    ...
    /**
     * Operation getProductBrand
     *
     * Get a product brand
     *
     * @param  string $product_brand_id The unique ID of the product brand. (required)
     ...
     */
    public function getProductBrand($product_brand_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getProductBrandWithHttpInfo($product_brand_id, $accept_language);
        return $response;
    }

    /**
     * Operation getProductBrandWithHttpInfo
     *
     * Get a product brand
     *
     * @param  string $product_brand_id The unique ID of the product brand. (required)
     ...
     */
    public function getProductBrandWithHttpInfo($product_brand_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200101';
        $request = $this->getProductBrandRequest($product_brand_id, $accept_language);
    ...
    /**
     * Operation getProductBrandAsync
     *
     * Get a product brand
     *
     * @param  string $product_brand_id The unique ID of the product brand. (required)
     ...
     */
    public function getProductBrandAsync($product_brand_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getProductBrandAsyncWithHttpInfo($product_brand_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductBrandAsyncWithHttpInfo
     *
     * Get a product brand
     *
     * @param  string $product_brand_id The unique ID of the product brand. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductBrandAsyncWithHttpInfo($product_brand_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200101';
        $request = $this->getProductBrandRequest($product_brand_id, $accept_language);
    ...
    /**
     * Create request for operation 'getProductBrand'
     *
     * @param  string $product_brand_id The unique ID of the product brand. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getProductBrandRequest($product_brand_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'product_brand_id' is set
        if ($product_brand_id === null || (is_array($product_brand_id) && count($product_brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product_brand_id when calling getProductBrand'
            );
        }

        $resourcePath = '/product-brands/{product_brand_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($product_brand_id !== null) {
            $resourcePath = str_replace(
                '{' . 'product_brand_id' . '}',
                ObjectSerializer::toPathValue($product_brand_id),
                $resourcePath
            );
        }
     ...
     */
    public function getProductBrands($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getProductBrandsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }
     ...
     */
    public function getProductBrandsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200100';
        $request = $this->getProductBrandsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductBrandsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getProductBrandsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductBrandsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200100';
        $request = $this->getProductBrandsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductBrandsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/product-brands';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postBulkProductBrands
     *
     * Create a batch of product brands
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ProductbrandsBatchBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postBulkProductBrands($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->postBulkProductBrandsWithHttpInfo($body, $accept_language);
    }

    /**
     * Operation postBulkProductBrandsWithHttpInfo
     *
     * Create a batch of product brands
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ProductbrandsBatchBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postBulkProductBrandsWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postBulkProductBrandsRequest($body, $accept_language);
    ...
    /**
     * Operation postBulkProductBrandsAsync
     *
     * Create a batch of product brands
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ProductbrandsBatchBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postBulkProductBrandsAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postBulkProductBrandsAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postBulkProductBrandsAsyncWithHttpInfo
     *
     * Create a batch of product brands
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ProductbrandsBatchBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postBulkProductBrandsAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postBulkProductBrandsRequest($body, $accept_language);
    ...
    /**
     * Create request for operation 'postBulkProductBrands'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ProductbrandsBatchBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postBulkProductBrandsRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postBulkProductBrands'
            );
        }

        $resourcePath = '/product-brands/batch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
