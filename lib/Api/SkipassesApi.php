...
/**
 * SkipassesApi Class Doc Comment
 *
 * @category Class
 * @package  CareCloud
 * @author   Swagger Codegen team
...
class SkipassesApi
{
    ...
    {
        list($response) = $this->getSkipassWithHttpInfo($skipass_id, $accept_language);
        return $response;
    }

    /**
     * Operation getSkipassWithHttpInfo
     *
     * Get a skipass
     *
     * @param  string $skipass_id The unique id of the skipass (required)
     ...
     */
    public function getSkipassAsync($skipass_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSkipassAsyncWithHttpInfo($skipass_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSkipassAsyncWithHttpInfo
     *
     * Get a skipass
     *
     * @param  string $skipass_id The unique id of the skipass (required)
    ...
    /**
     * Create request for operation 'getSkipass'
     *
     * @param  string $skipass_id The unique id of the skipass (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getSkipassRequest($skipass_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'skipass_id' is set
        if ($skipass_id === null || (is_array($skipass_id) && count($skipass_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $skipass_id when calling getSkipass'
            );
        }

        $resourcePath = '/skipasses/{skipass_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($skipass_id !== null) {
            $resourcePath = str_replace(
                '{' . 'skipass_id' . '}',
                ObjectSerializer::toPathValue($skipass_id),
                $resourcePath
            );
        }
    ...
    {
        list($response) = $this->getSkipassesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $pos_id, $external_order_id, $name, $resort_name, $customer_category_name, $card_id, $customer_id, $skipass_type_id, $state, $external_skipass_id, $is_valid, $is_cancelled);
        return $response;
    }

    /**
     * Operation getSkipassesWithHttpInfo
     *
     * Get all skipasses
     *
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSkipassesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $pos_id = null, $external_order_id = null, $name = null, $resort_name = null, $customer_category_name = null, $card_id = null, $customer_id = null, $skipass_type_id = null, $state = null, $external_skipass_id = null, $is_valid = null, $is_cancelled = null)
    {
        return $this->getSkipassesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $pos_id, $external_order_id, $name, $resort_name, $customer_category_name, $card_id, $customer_id, $skipass_type_id, $state, $external_skipass_id, $is_valid, $is_cancelled)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSkipassesAsyncWithHttpInfo
     *
     * Get all skipasses
     *
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Create request for operation 'getSkipasses'
     *
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSkipassesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $pos_id = null, $external_order_id = null, $name = null, $resort_name = null, $customer_category_name = null, $card_id = null, $customer_id = null, $skipass_type_id = null, $state = null, $external_skipass_id = null, $is_valid = null, $is_cancelled = null)
    {

        $resourcePath = '/skipasses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($skipass_type_id !== null) {
            $queryParams['skipass_type_id'] = ObjectSerializer::toQueryValue($skipass_type_id, null);
        }
        // query params
        if ($state !== null) {
        ...
        // query params
        if ($external_skipass_id !== null) {
            $queryParams['external_skipass_id'] = ObjectSerializer::toQueryValue($external_skipass_id, null);
        }
        // query params
        if ($is_valid !== null) {
    ...
    /**
     * Operation getSkipassesOverview
     *
    ...
    {
        list($response) = $this->getSkipassesOverviewWithHttpInfo($accept_language, $valid_from, $valid_to);
        return $response;
    }

    /**
     * Operation getSkipassesOverviewWithHttpInfo
     *
     * Get skipasses overview
     *
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getSkipassesOverviewAsync
     *
     * Get skipasses overview
     *
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSkipassesOverviewAsync($accept_language = 'cs, en-gb;q=0.8', $valid_from = null, $valid_to = null)
    {
        return $this->getSkipassesOverviewAsyncWithHttpInfo($accept_language, $valid_from, $valid_to)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSkipassesOverviewAsyncWithHttpInfo
     *
     * Get skipasses overview
     *
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSkipassesOverviewRequest($accept_language = 'cs, en-gb;q=0.8', $valid_from = null, $valid_to = null)
    {

        $resourcePath = '/skipasses/actions/overview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation putSkipass
     *
     * Update a skipass
     *
     * @param  \CareCloud\Model\SkipassesSkipassIdBody $body body (required)
     * @param  string $skipass_id The unique id of the skipass (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CareCloud\ApiException on non-2xx response
     ...
     * @return void
     */
    public function putSkipass($body, $skipass_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->putSkipassWithHttpInfo($body, $skipass_id, $accept_language);
    }

    /**
     * Operation putSkipassWithHttpInfo
     *
     * Update a skipass
     *
     * @param  \CareCloud\Model\SkipassesSkipassIdBody $body (required)
     * @param  string $skipass_id The unique id of the skipass (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CareCloud\ApiException on non-2xx response
     ...
     */
    public function putSkipassWithHttpInfo($body, $skipass_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->putSkipassRequest($body, $skipass_id, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSkipassAsync($body, $skipass_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->putSkipassAsyncWithHttpInfo($body, $skipass_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putSkipassAsyncWithHttpInfo
     *
     * Update a skipass
     *
     * @param  \CareCloud\Model\SkipassesSkipassIdBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSkipassAsyncWithHttpInfo($body, $skipass_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->putSkipassRequest($body, $skipass_id, $accept_language);
    ...
    /**
     * Create request for operation 'putSkipass'
     *
     * @param  \CareCloud\Model\SkipassesSkipassIdBody $body (required)
     * @param  string $skipass_id The unique id of the skipass (required)
     * @param  string $accept_language The unique id of the language code by ISO 639-1 (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putSkipassRequest($body, $skipass_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling putSkipass'
            );
        }
        // verify the required parameter 'skipass_id' is set
        if ($skipass_id === null || (is_array($skipass_id) && count($skipass_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $skipass_id when calling putSkipass'
            );
        }
