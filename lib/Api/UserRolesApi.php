...
class UserRolesApi
{
     ...
     *
     * @param  string $user_role_id The unique ID of the user role. (required)
    ...
    {
        list($response) = $this->getUserRoleWithHttpInfo($user_role_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getUserRoleAsync($user_role_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getUserRoleAsyncWithHttpInfo($user_role_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getUserRoleRequest($user_role_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'user_role_id' is set
        if ($user_role_id === null || (is_array($user_role_id) && count($user_role_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_role_id when calling getUserRole'
            );
        }

        $resourcePath = '/user-roles/{user_role_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($user_role_id !== null) {
            $resourcePath = str_replace(
                '{' . 'user_role_id' . '}',
                ObjectSerializer::toPathValue($user_role_id),
                $resourcePath
            );
        }
    ...
    {
        list($response) = $this->getUserRolesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserRolesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getUserRolesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserRolesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
