...
class PointsApi
{
     ...
     * Get a point record
     *
     * @param  string $point_id The unique ID of the point record. (required)
    ...
    {
        list($response) = $this->getPointWithHttpInfo($point_id, $accept_language);
        return $response;
    }

    /**
     * Operation getPointWithHttpInfo
     *
     * Get a point record
     *
     * @param  string $point_id The unique ID of the point record. (required)
     ...
     */
    public function getPointAsync($point_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getPointAsyncWithHttpInfo($point_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPointAsyncWithHttpInfo
     *
     * Get a point record
     *
     * @param  string $point_id The unique ID of the point record. (required)
    ...
    /**
     * Create request for operation 'getPoint'
     *
     * @param  string $point_id The unique ID of the point record. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getPointRequest($point_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'point_id' is set
        if ($point_id === null || (is_array($point_id) && count($point_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $point_id when calling getPoint'
            );
        }

        $resourcePath = '/points/{point_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getPointsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $point_type_id, $create_point_time_from, $create_point_time_to);
        return $response;
    }

    /**
     * Operation getPointsWithHttpInfo
     *
     * Get all point records
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPointsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $point_type_id = null, $create_point_time_from = null, $create_point_time_to = null)
    {
        return $this->getPointsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $point_type_id, $create_point_time_from, $create_point_time_to)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPointsAsyncWithHttpInfo
     *
     * Get all point records
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @param  string|null $create_point_time_from Date and time from of the create point record. *(YYYY-MM-DD HH:MM:SS)* (optional)
     * @param  string|null $create_point_time_to Date and time to of the create point record. *(YYYY-MM-DD HH:MM:SS)* (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    ...
    /**
     * Create request for operation 'getPoints'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPointsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $point_type_id = null, $create_point_time_from = null, $create_point_time_to = null)
    {
        ...
        // query params
        if ($create_point_time_from !== null) {
            $queryParams['create_point_time_from'] = ObjectSerializer::toQueryValue($create_point_time_from, null);
        }
        // query params
        if ($create_point_time_to !== null) {
            $queryParams['create_point_time_to'] = ObjectSerializer::toQueryValue($create_point_time_to, null);
        }
        // header params
        if ($accept_language !== null) {
            $headerParams['Accept-Language'] = ObjectSerializer::toHeaderValue($accept_language);
    ...
    /**
     * Operation getSubPointPurchases
     *
    ...
    {
        list($response) = $this->getSubPointPurchasesWithHttpInfo($point_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $store_id, $customer_id, $type_id, $payment_time_from, $payment_time_to, $purchase_items_extension, $external_purchase_id);
        return $response;
    }

    /**
     * Operation getSubPointPurchasesWithHttpInfo
     *
     * Get a collection of purchases
     *
     * @param  string $point_id The unique ID of the point record. (required)
    ...
    /**
     * Operation getSubPointPurchasesAsync
     *
     * Get a collection of purchases
     *
     * @param  string $point_id The unique ID of the point record. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubPointPurchasesAsync($point_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $store_id = null, $customer_id = null, $type_id = null, $payment_time_from = null, $payment_time_to = null, $purchase_items_extension = 'false', $external_purchase_id = null)
    {
        return $this->getSubPointPurchasesAsyncWithHttpInfo($point_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $store_id, $customer_id, $type_id, $payment_time_from, $payment_time_to, $purchase_items_extension, $external_purchase_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSubPointPurchasesAsyncWithHttpInfo
     *
     * Get a collection of purchases
     *
     * @param  string $point_id The unique ID of the point record. (required)
    ...
    /**
     * Create request for operation 'getSubPointPurchases'
     *
     * @param  string $point_id The unique ID of the point record. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubPointPurchasesRequest($point_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $store_id = null, $customer_id = null, $type_id = null, $payment_time_from = null, $payment_time_to = null, $purchase_items_extension = 'false', $external_purchase_id = null)
    {
        // verify the required parameter 'point_id' is set
        if ($point_id === null || (is_array($point_id) && count($point_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $point_id when calling getSubPointPurchases'
            );
        }

        $resourcePath = '/points/{point_id}/purchases';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        $this->postPointsAssignWithHttpInfo($body, $accept_language);
    }

    /**
     * Operation postPointsAssignWithHttpInfo
     *
     * Assign of points
     *
    ...
    /**
     * Operation postPointsAssignAsync
     *
     * Assign of points
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsAssignpointsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointsAssignAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postPointsAssignAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPointsAssignAsyncWithHttpInfo
     *
     * Assign of points
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsAssignpointsBody $body (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPointsAssignRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postPointsAssign'
            );
        }

        $resourcePath = '/points/actions/assign-points';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postPointsRedemption
     *
     * Points redemption
     *
    ...
    {
        list($response) = $this->postPointsRedemptionWithHttpInfo($body, $accept_language);
        return $response;
    }

    /**
     * Operation postPointsRedemptionWithHttpInfo
     *
     * Points redemption
     *
    ...
    /**
     * Operation postPointsRedemptionAsync
     *
     * Points redemption
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsReducepointsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointsRedemptionAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postPointsRedemptionAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPointsRedemptionAsyncWithHttpInfo
     *
     * Points redemption
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsReducepointsBody $body (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPointsRedemptionRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postPointsRedemption'
            );
        }
     ...
     * @return void
     */
    public function postPointsTransfer($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->postPointsTransferWithHttpInfo($body, $accept_language);
    }

    /**
     * Operation postPointsTransferWithHttpInfo
     *
     * Transfer points
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPointsTransferWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postPointsTransferRequest($body, $accept_language);
    ...
    /**
     * Operation postPointsTransferAsync
     *
     * Transfer points
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsTransferpointsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointsTransferAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postPointsTransferAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPointsTransferAsyncWithHttpInfo
     *
     * Transfer points
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsTransferpointsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointsTransferAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postPointsTransferRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPointsTransferRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postPointsTransfer'
            );
        }

        $resourcePath = '/points/actions/transfer-points';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
