...
class PurchaseItemTypesApi
{
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseItemTypes200Response
     */
    public function getPurchaseItemTypes($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        list($response) = $this->getPurchaseItemTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id);
        return $response;
    }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseItemTypes200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPurchaseItemTypesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseItemTypes200Response';
        $request = $this->getPurchaseItemTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseItemTypes200Response',
     ...
     */
    public function getPurchaseItemTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        return $this->getPurchaseItemTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPurchaseItemTypesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseItemTypes200Response';
        $request = $this->getPurchaseItemTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id);
     ...
     */
    protected function getPurchaseItemTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
