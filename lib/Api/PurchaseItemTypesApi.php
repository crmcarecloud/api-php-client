...
/**
 * PurchaseItemTypesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class PurchaseItemTypesApi
{
    ...
    /**
     * Operation getPurchaseItemTypes
     *
    ...
    {
        list($response) = $this->getPurchaseItemTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getPurchaseItemTypesWithHttpInfo
     *
     * Get all purchase item types
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getPurchaseItemTypesAsync
     *
     * Get all purchase item types
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getPurchaseItemTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getPurchaseItemTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPurchaseItemTypesAsyncWithHttpInfo
     *
     * Get all purchase item types
     *
    ...
    /**
     * Create request for operation 'getPurchaseItemTypes'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getPurchaseItemTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/purchase-item-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
