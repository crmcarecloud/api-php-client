...
class ConsentsApi
{
     ...
     */
    public function getConsents($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null, $text_id = null)
    {
        list($response) = $this->getConsentsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id, $text_id);
        return $response;
    }
     ...
     */
    public function getConsentsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null, $text_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetConsents200Response';
        $request = $this->getConsentsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id, $text_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getConsentsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null, $text_id = null)
    {
        return $this->getConsentsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id, $text_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getConsentsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null, $text_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetConsents200Response';
        $request = $this->getConsentsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id, $text_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getConsentsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null, $text_id = null)
    {
