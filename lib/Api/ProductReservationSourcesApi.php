...
/**
 * ProductReservationSourcesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductReservationSourcesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation getProductReservationSource
     *
     * Detail of a product reservation source
     *
     * @param  string $product_reservation_source_id The unique ID of the product reservation source in CareCloud. (required)
     ...
     */
    public function getProductReservationSource($product_reservation_source_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getProductReservationSourceWithHttpInfo($product_reservation_source_id, $accept_language);
        return $response;
    }

    /**
     * Operation getProductReservationSourceWithHttpInfo
     *
     * Detail of a product reservation source
     *
     * @param  string $product_reservation_source_id The unique ID of the product reservation source in CareCloud. (required)
     ...
     */
    public function getProductReservationSourceWithHttpInfo($product_reservation_source_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200108';
        $request = $this->getProductReservationSourceRequest($product_reservation_source_id, $accept_language);
    ...
    /**
     * Operation getProductReservationSourceAsync
     *
     * Detail of a product reservation source
     *
     * @param  string $product_reservation_source_id The unique ID of the product reservation source in CareCloud. (required)
     ...
     */
    public function getProductReservationSourceAsync($product_reservation_source_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getProductReservationSourceAsyncWithHttpInfo($product_reservation_source_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductReservationSourceAsyncWithHttpInfo
     *
     * Detail of a product reservation source
     *
     * @param  string $product_reservation_source_id The unique ID of the product reservation source in CareCloud. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductReservationSourceAsyncWithHttpInfo($product_reservation_source_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200108';
        $request = $this->getProductReservationSourceRequest($product_reservation_source_id, $accept_language);
    ...
    /**
     * Create request for operation 'getProductReservationSource'
     *
     * @param  string $product_reservation_source_id The unique ID of the product reservation source in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getProductReservationSourceRequest($product_reservation_source_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'product_reservation_source_id' is set
        if ($product_reservation_source_id === null || (is_array($product_reservation_source_id) && count($product_reservation_source_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product_reservation_source_id when calling getProductReservationSource'
            );
        }

        $resourcePath = '/product-reservation-sources/{product_reservation_source_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($product_reservation_source_id !== null) {
            $resourcePath = str_replace(
                '{' . 'product_reservation_source_id' . '}',
                ObjectSerializer::toPathValue($product_reservation_source_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getProductReservationSources
     *
     ...
     */
    public function getProductReservationSources($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        list($response) = $this->getProductReservationSourcesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getProductReservationSourcesWithHttpInfo
     *
     * Get all product reservation sources
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getProductReservationSourcesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200107';
        $request = $this->getProductReservationSourcesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Operation getProductReservationSourcesAsync
     *
     * Get all product reservation sources
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductReservationSourcesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getProductReservationSourcesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductReservationSourcesAsyncWithHttpInfo
     *
     * Get all product reservation sources
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductReservationSourcesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200107';
        $request = $this->getProductReservationSourcesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Create request for operation 'getProductReservationSources'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProductReservationSourcesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/product-reservation-sources';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
