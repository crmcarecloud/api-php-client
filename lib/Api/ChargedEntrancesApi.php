...
class ChargedEntrancesApi
{
     ...
     */
    public function getEntrancesCustomerStats($customer_id, $accept_language = 'cs, en-gb;q=0.8', $date_from = null, $date_to = null)
    {
        list($response) = $this->getEntrancesCustomerStatsWithHttpInfo($customer_id, $accept_language, $date_from, $date_to);
        return $response;
    }
     ...
     */
    public function getEntrancesCustomerStatsWithHttpInfo($customer_id, $accept_language = 'cs, en-gb;q=0.8', $date_from = null, $date_to = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200143';
        $request = $this->getEntrancesCustomerStatsRequest($customer_id, $accept_language, $date_from, $date_to);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEntrancesCustomerStatsAsync($customer_id, $accept_language = 'cs, en-gb;q=0.8', $date_from = null, $date_to = null)
    {
        return $this->getEntrancesCustomerStatsAsyncWithHttpInfo($customer_id, $accept_language, $date_from, $date_to)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEntrancesCustomerStatsAsyncWithHttpInfo($customer_id, $accept_language = 'cs, en-gb;q=0.8', $date_from = null, $date_to = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200143';
        $request = $this->getEntrancesCustomerStatsRequest($customer_id, $accept_language, $date_from, $date_to);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEntrancesCustomerStatsRequest($customer_id, $accept_language = 'cs, en-gb;q=0.8', $date_from = null, $date_to = null)
    {
