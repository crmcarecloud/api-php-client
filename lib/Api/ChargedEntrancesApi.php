...
class ChargedEntrancesApi
{
     ...
     * @param  string $resort_name string Name of the resort where is an entrance charged (optional)
     * @param  string $customer_category_name Name of the customer category (optional)
     * @param  string $card_id Id of card used for charging entrance (optional)
     ...
     * @param  string|null $resort_name string Name of the resort where is an entrance charged (optional)
     * @param  string|null $customer_category_name Name of the customer category (optional)
     * @param  string|null $card_id Id of card used for charging entrance (optional)
