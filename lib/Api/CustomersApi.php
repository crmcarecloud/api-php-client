...
class CustomersApi
{
     ...
     */
    public function postSubCustomerRelatedCustomers($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->postSubCustomerRelatedCustomersWithHttpInfo($body, $accept_language);
        return $response;
    }
     ...
     */
    public function postSubCustomerRelatedCustomersWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20112';
        $request = $this->postSubCustomerRelatedCustomersRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSubCustomerRelatedCustomersAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postSubCustomerRelatedCustomersAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSubCustomerRelatedCustomersAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20112';
        $request = $this->postSubCustomerRelatedCustomersRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postSubCustomerRelatedCustomersRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
