...
class AgreementsApi
{
     ...
     */
    public function getAgreements($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        list($response) = $this->getAgreementsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }
     ...
     */
    public function getAgreementsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200';
        $request = $this->getAgreementsRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgreementsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getAgreementsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgreementsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200';
        $request = $this->getAgreementsRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAgreementsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
