...
class AgreementsApi
{
     ...
     *
     * @param  string $agreement_id The unique ID of an agreement in CareCloud. (required)
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2001
     */
    public function getAgreement($agreement_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getAgreementWithHttpInfo($agreement_id, $accept_language);
        return $response;
    }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAgreementWithHttpInfo($agreement_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2001';
        $request = $this->getAgreementRequest($agreement_id, $accept_language);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2001',
     ...
     */
    public function getAgreementAsync($agreement_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getAgreementAsyncWithHttpInfo($agreement_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgreementAsyncWithHttpInfo($agreement_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2001';
        $request = $this->getAgreementRequest($agreement_id, $accept_language);
     ...
     */
    protected function getAgreementRequest($agreement_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'agreement_id' is set
        if ($agreement_id === null || (is_array($agreement_id) && count($agreement_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $agreement_id when calling getAgreement'
            );
        }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200
     */
    public function getAgreements($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null)
    {
        list($response) = $this->getAgreementsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id);
        return $response;
    }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAgreementsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200';
        $request = $this->getAgreementsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgreementsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null)
    {
        return $this->getAgreementsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAgreementsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200';
        $request = $this->getAgreementsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $communication_channel_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAgreementsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $communication_channel_id = null)
    {
