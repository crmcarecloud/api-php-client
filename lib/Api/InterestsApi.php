...
class InterestsApi
{
     ...
     * Get an interest
     *
     * @param  string $interest_id The unique ID of the interest. (required)
    ...
    {
        list($response) = $this->getInterestWithHttpInfo($interest_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getInterestAsync($interest_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getInterestAsyncWithHttpInfo($interest_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getInterestRequest($interest_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'interest_id' is set
        if ($interest_id === null || (is_array($interest_id) && count($interest_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $interest_id when calling getInterest'
            );
        }

        $resourcePath = '/interests/{interest_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getInterestsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getInterestsWithHttpInfo
     *
     * Get all interests
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInterestsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getInterestsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInterestsAsyncWithHttpInfo
     *
     * Get all interests
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInterestsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/interests';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
