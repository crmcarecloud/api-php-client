...
/**
 * CustomerSourcesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class CustomerSourcesApi
{
    ...
    /**
     * Operation getCustomerSource
     *
     * Detail of a customer source
     *
     * @param  string $customer_source_id The unique ID of the customer source. It identifies the system where the customer belongs or the customer account was created. (required)
    ...
    {
        list($response) = $this->getCustomerSourceWithHttpInfo($customer_source_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCustomerSourceWithHttpInfo
     *
     * Detail of a customer source
     *
     * @param  string $customer_source_id The unique ID of the customer source. It identifies the system where the customer belongs or the customer account was created. (required)
    ...
    /**
     * Operation getCustomerSourceAsync
     *
     * Detail of a customer source
     *
     * @param  string $customer_source_id The unique ID of the customer source. It identifies the system where the customer belongs or the customer account was created. (required)
     ...
     */
    public function getCustomerSourceAsync($customer_source_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCustomerSourceAsyncWithHttpInfo($customer_source_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerSourceAsyncWithHttpInfo
     *
     * Detail of a customer source
     *
     * @param  string $customer_source_id The unique ID of the customer source. It identifies the system where the customer belongs or the customer account was created. (required)
    ...
    /**
     * Create request for operation 'getCustomerSource'
     *
     * @param  string $customer_source_id The unique ID of the customer source. It identifies the system where the customer belongs or the customer account was created. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getCustomerSourceRequest($customer_source_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'customer_source_id' is set
        if ($customer_source_id === null || (is_array($customer_source_id) && count($customer_source_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_source_id when calling getCustomerSource'
            );
        }

        $resourcePath = '/customer-sources/{customer_source_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($customer_source_id !== null) {
            $resourcePath = str_replace(
                '{' . 'customer_source_id' . '}',
                ObjectSerializer::toPathValue($customer_source_id),
                $resourcePath
            );
        }
     ...
     */
    public function getCustomerSources($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        list($response) = $this->getCustomerSourcesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getCustomerSourcesWithHttpInfo
     *
     * Get customer sources
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getCustomerSourcesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20061';
        $request = $this->getCustomerSourcesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
    ...
    /**
     * Operation getCustomerSourcesAsync
     *
     * Get customer sources
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerSourcesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getCustomerSourcesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerSourcesAsyncWithHttpInfo
     *
     * Get customer sources
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerSourcesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20061';
        $request = $this->getCustomerSourcesRequest($accept_language, $count, $offset, $sort_field, $sort_direction);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomerSourcesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/customer-sources';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
