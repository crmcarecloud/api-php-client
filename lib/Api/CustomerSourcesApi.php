...
class CustomerSourcesApi
{
    ...
    {
        list($response) = $this->getCustomerSourcesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_source_text_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerSourcesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_source_text_id = null)
    {
        return $this->getCustomerSourcesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_source_text_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomerSourcesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_source_text_id = null)
    {
        ...
        // query params
        if ($customer_source_text_id !== null) {
            $queryParams['customer_source_text_id'] = ObjectSerializer::toQueryValue($customer_source_text_id, null);
        }
        // header params
        if ($accept_language !== null) {
            $headerParams['Accept-Language'] = ObjectSerializer::toHeaderValue($accept_language);
