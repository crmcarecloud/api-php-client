...
class RewardsApi
{
    ...
    /**
     * Operation postRewardCreateSimpleReward
     *
     * Create a Simple reward
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsCreatesimplerewardBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\PostRewardCreateSimpleReward201Response
     */
    public function postRewardCreateSimpleReward($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->postRewardCreateSimpleRewardWithHttpInfo($body, $accept_language);
        return $response;
    }

    /**
     * Operation postRewardCreateSimpleRewardWithHttpInfo
     *
     * Create a Simple reward
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsCreatesimplerewardBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\PostRewardCreateSimpleReward201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postRewardCreateSimpleRewardWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\PostRewardCreateSimpleReward201Response';
        $request = $this->postRewardCreateSimpleRewardRequest($body, $accept_language);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\PostRewardCreateSimpleReward201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postRewardCreateSimpleRewardAsync
     *
     * Create a Simple reward
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsCreatesimplerewardBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postRewardCreateSimpleRewardAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postRewardCreateSimpleRewardAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postRewardCreateSimpleRewardAsyncWithHttpInfo
     *
     * Create a Simple reward
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsCreatesimplerewardBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postRewardCreateSimpleRewardAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\PostRewardCreateSimpleReward201Response';
        $request = $this->postRewardCreateSimpleRewardRequest($body, $accept_language);
    ...
    /**
     * Create request for operation 'postRewardCreateSimpleReward'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsCreatesimplerewardBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postRewardCreateSimpleRewardRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postRewardCreateSimpleReward'
            );
        }

        $resourcePath = '/rewards/actions/create-simple-reward';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
