...
/**
 * CustomerPropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class CustomerPropertiesApi
{
    ...
    /**
     * Operation getCustomerProperties
     *
     ...
     */
    public function getCustomerProperties($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getCustomerPropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getCustomerPropertiesWithHttpInfo
     *
     * Get all customer properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getCustomerPropertiesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20058';
        $request = $this->getCustomerPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Operation getCustomerPropertiesAsync
     *
     * Get all customer properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getCustomerPropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getCustomerPropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerPropertiesAsyncWithHttpInfo
     *
     * Get all customer properties
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerPropertiesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20058';
        $request = $this->getCustomerPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getCustomerProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getCustomerPropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/customer-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getCustomerProperty
     *
     * Get a customer property
     *
     * @param  string $customer_property_id The unique ID of the customer property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getCustomerProperty($customer_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getCustomerPropertyWithHttpInfo($customer_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCustomerPropertyWithHttpInfo
     *
     * Get a customer property
     *
     * @param  string $customer_property_id The unique ID of the customer property. (required)
     ...
     */
    public function getCustomerPropertyWithHttpInfo($customer_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getCustomerPropertyRequest($customer_property_id, $accept_language);
    ...
    /**
     * Operation getCustomerPropertyAsync
     *
     * Get a customer property
     *
     * @param  string $customer_property_id The unique ID of the customer property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerPropertyAsync($customer_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCustomerPropertyAsyncWithHttpInfo($customer_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerPropertyAsyncWithHttpInfo
     *
     * Get a customer property
     *
     * @param  string $customer_property_id The unique ID of the customer property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerPropertyAsyncWithHttpInfo($customer_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getCustomerPropertyRequest($customer_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getCustomerProperty'
     *
     * @param  string $customer_property_id The unique ID of the customer property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomerPropertyRequest($customer_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'customer_property_id' is set
        if ($customer_property_id === null || (is_array($customer_property_id) && count($customer_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_property_id when calling getCustomerProperty'
            );
        }

        $resourcePath = '/customer-properties/{customer_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($customer_property_id !== null) {
            $resourcePath = str_replace(
                '{' . 'customer_property_id' . '}',
                ObjectSerializer::toPathValue($customer_property_id),
                $resourcePath
            );
        }
