...
class EventsApi
{
     ...
     * Get an event
     *
     * @param  string $event_id The unique ID of the event. (required)
    ...
    {
        list($response) = $this->getEventWithHttpInfo($event_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getEventAsync($event_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getEventAsyncWithHttpInfo($event_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getEventRequest($event_id, $accept_language = 'cs, en-gb;q=0.8')
    {
     ...
     */
    public function getEvents($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $event_type_id = null, $customer_id = null, $external_id = null)
    {
        list($response) = $this->getEventsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $event_type_id, $customer_id, $external_id);
        return $response;
    }
     ...
     */
    public function getEventsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $event_type_id = null, $customer_id = null, $external_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20065';
        $request = $this->getEventsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $event_type_id, $customer_id, $external_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $event_type_id = null, $customer_id = null, $external_id = null)
    {
        return $this->getEventsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $event_type_id, $customer_id, $external_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEventsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $event_type_id = null, $customer_id = null, $external_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20065';
        $request = $this->getEventsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $event_type_id, $customer_id, $external_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEventsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $event_type_id = null, $customer_id = null, $external_id = null)
    {
    ...
    /**
     * Operation getSubEventProperties
     *
    ...
    {
        list($response) = $this->getSubEventPropertiesWithHttpInfo($event_id, $accept_language);
        return $response;
    }

    /**
     * Operation getSubEventPropertiesWithHttpInfo
     *
     * Get a collection of event properties records
     *
     * @param  string $event_id The unique ID of the event. (required)
    ...
    /**
     * Operation getSubEventPropertiesAsync
     *
     * Get a collection of event properties records
     *
     * @param  string $event_id The unique ID of the event. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubEventPropertiesAsync($event_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getSubEventPropertiesAsyncWithHttpInfo($event_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSubEventPropertiesAsyncWithHttpInfo
     *
     * Get a collection of event properties records
     *
     * @param  string $event_id The unique ID of the event. (required)
    ...
    /**
     * Create request for operation 'getSubEventProperties'
     *
     * @param  string $event_id The unique ID of the event. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubEventPropertiesRequest($event_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'event_id' is set
        if ($event_id === null || (is_array($event_id) && count($event_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_id when calling getSubEventProperties'
            );
        }

        $resourcePath = '/events/{event_id}/property-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Create a new event
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\EventsBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->postEventWithHttpInfo($body, $accept_language);
        return $response;
    }
     ...
     * Create a new event
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\EventsBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postEventAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postEventAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postEventRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postEvent'
            );
        }
