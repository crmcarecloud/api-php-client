...
class BookingTicketsApi
{
    ...
    {
        list($response) = $this->getSubBookingTicketsTimeSlotsWithHttpInfo($booking_ticket_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $free_only, $time_from, $time_to, $booking_ticket_property_id, $booking_ticket_property_value, $customer_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubBookingTicketsTimeSlotsAsync($booking_ticket_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $free_only = null, $time_from = null, $time_to = null, $booking_ticket_property_id = null, $booking_ticket_property_value = null, $customer_id = null)
    {
        return $this->getSubBookingTicketsTimeSlotsAsyncWithHttpInfo($booking_ticket_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $free_only, $time_from, $time_to, $booking_ticket_property_id, $booking_ticket_property_value, $customer_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubBookingTicketsTimeSlotsRequest($booking_ticket_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $free_only = null, $time_from = null, $time_to = null, $booking_ticket_property_id = null, $booking_ticket_property_value = null, $customer_id = null)
    {
        // verify the required parameter 'booking_ticket_id' is set
        if ($booking_ticket_id === null || (is_array($booking_ticket_id) && count($booking_ticket_id) === 0)) {
            throw new \InvalidArgumentException(
