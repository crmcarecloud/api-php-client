...
class CountriesApi
{
     ...
     * @return \CareCloud\Model\InlineResponse20013
     */
    public function getCountries($accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getCountriesWithHttpInfo($accept_language);
        return $response;
    }
     ...
     * @throws \CareCloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CareCloud\Model\InlineResponse20013, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCountriesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CareCloud\Model\InlineResponse20013';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CareCloud\Model\InlineResponse20013',
     ...
     */
    public function getCountriesAsync($accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCountriesAsyncWithHttpInfo($accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getCountriesRequest($accept_language = 'cs, en-gb;q=0.8')
    {
