...
class CountriesApi
{
     ...
     * @param  string $country_id The unique ID of a country represented by ISO code. (optional)
     * @param  string $country_name Name or part of the name of the country you looking for. (optional)
     *
    ...
    {
        list($response) = $this->getCountriesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $country_id, $country_name);
        return $response;
    }
     ...
     */
    public function getCountriesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $country_id = null, $country_name = null)
    {
        return $this->getCountriesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $country_id, $country_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  string|null $country_id The unique ID of a country represented by ISO code. (optional)
     * @param  string|null $country_name Name or part of the name of the country you looking for. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
     ...
     */
    protected function getCountriesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $country_id = null, $country_name = null)
    {
        ...
        // query params
        if ($country_id !== null) {
            $queryParams['country_id'] = ObjectSerializer::toQueryValue($country_id, null);
        }
        // query params
        if ($country_name !== null) {
            $queryParams['country_name'] = ObjectSerializer::toQueryValue($country_name, null);
        }
        // header params
