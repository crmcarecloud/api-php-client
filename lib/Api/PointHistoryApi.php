...
class PointHistoryApi
{
    ...
    {
        list($response) = $this->getPointHistoryWithHttpInfo($customer_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $store_id, $partner_id, $time_from, $time_to, $point_operation_type, $point_operation_note);
        return $response;
    }
     ...
     */
    public function getPointHistoryAsync($customer_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $store_id = null, $partner_id = null, $time_from = null, $time_to = null, $point_operation_type = null, $point_operation_note = null)
    {
        return $this->getPointHistoryAsyncWithHttpInfo($customer_id, $accept_language, $count, $offset, $sort_field, $sort_direction, $store_id, $partner_id, $time_from, $time_to, $point_operation_type, $point_operation_note)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getPointHistoryRequest($customer_id, $accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $store_id = null, $partner_id = null, $time_from = null, $time_to = null, $point_operation_type = null, $point_operation_note = null)
    {
