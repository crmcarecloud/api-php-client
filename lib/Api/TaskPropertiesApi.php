...
/**
 * TaskPropertiesApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class TaskPropertiesApi
{
     ...
     */
    public function getTaskProperties($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getTaskPropertiesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }

    /**
     * Operation getTaskPropertiesWithHttpInfo
     *
     * Get all task properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getTaskPropertiesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200161';
        $request = $this->getTaskPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Operation getTaskPropertiesAsync
     *
     * Get all task properties
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getTaskPropertiesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getTaskPropertiesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTaskPropertiesAsyncWithHttpInfo
     *
     * Get all task properties
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaskPropertiesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse200161';
        $request = $this->getTaskPropertiesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
    ...
    /**
     * Create request for operation 'getTaskProperties'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getTaskPropertiesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {

        $resourcePath = '/task-properties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getTaskProperty
     *
     * Get a task property
     *
     * @param  string $task_property_id The unique ID of the task property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getTaskProperty($task_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getTaskPropertyWithHttpInfo($task_property_id, $accept_language);
        return $response;
    }

    /**
     * Operation getTaskPropertyWithHttpInfo
     *
     * Get a task property
     *
     * @param  string $task_property_id The unique ID of the task property. (required)
     ...
     */
    public function getTaskPropertyWithHttpInfo($task_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getTaskPropertyRequest($task_property_id, $accept_language);
    ...
    /**
     * Operation getTaskPropertyAsync
     *
     * Get a task property
     *
     * @param  string $task_property_id The unique ID of the task property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaskPropertyAsync($task_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getTaskPropertyAsyncWithHttpInfo($task_property_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTaskPropertyAsyncWithHttpInfo
     *
     * Get a task property
     *
     * @param  string $task_property_id The unique ID of the task property. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaskPropertyAsyncWithHttpInfo($task_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2008';
        $request = $this->getTaskPropertyRequest($task_property_id, $accept_language);
    ...
    /**
     * Create request for operation 'getTaskProperty'
     *
     * @param  string $task_property_id The unique ID of the task property. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTaskPropertyRequest($task_property_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'task_property_id' is set
        if ($task_property_id === null || (is_array($task_property_id) && count($task_property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $task_property_id when calling getTaskProperty'
            );
        }

        $resourcePath = '/task-properties/{task_property_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($task_property_id !== null) {
            $resourcePath = str_replace(
                '{' . 'task_property_id' . '}',
                ObjectSerializer::toPathValue($task_property_id),
                $resourcePath
            );
        }
