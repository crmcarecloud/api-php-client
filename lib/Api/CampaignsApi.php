...
class CampaignsApi
{
     ...
     *
     * @param  string $campaign_id The unique ID of the campaign in CareCloud. (required)
     ...
     */
    public function getCampaign($campaign_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->getCampaignWithHttpInfo($campaign_id, $accept_language);
        return $response;
    }
     ...
     */
    public function getCampaignWithHttpInfo($campaign_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20012';
        $request = $this->getCampaignRequest($campaign_id, $accept_language);
     ...
     */
    public function getCampaignAsync($campaign_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCampaignAsyncWithHttpInfo($campaign_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignAsyncWithHttpInfo($campaign_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20012';
        $request = $this->getCampaignRequest($campaign_id, $accept_language);
     ...
     */
    protected function getCampaignRequest($campaign_id, $accept_language = 'cs, en-gb;q=0.8')
    {
     ...
     */
    public function getCampaigns($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        list($response) = $this->getCampaignsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
        return $response;
    }
     ...
     */
    public function getCampaignsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20011';
        $request = $this->getCampaignsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        return $this->getCampaignsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse20011';
        $request = $this->getCampaignsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCampaignsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null)
    {
     ...
     * Create a campaign
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\CampaignsBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postCampaign($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        list($response) = $this->postCampaignWithHttpInfo($body, $accept_language);
        return $response;
    }
     ...
     * Create a campaign
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\CampaignsBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postCampaignWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2011';
        $request = $this->postCampaignRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCampaignAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postCampaignAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCampaignAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\InlineResponse2011';
        $request = $this->postCampaignRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postCampaignRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postCampaign'
            );
        }
