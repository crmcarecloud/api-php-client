...
class CampaignsApi
{
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaign200Response
     */
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaign200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignWithHttpInfo($campaign_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaign200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaign200Response',
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaigns200Response
     */
    public function getCampaigns($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $external_id = null)
    {
        list($response) = $this->getCampaignsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $external_id);
        return $response;
    }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaigns200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $external_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaigns200Response';
        $request = $this->getCampaignsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $external_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaigns200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $external_id = null)
    {
        return $this->getCampaignsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $external_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $external_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCampaigns200Response';
        $request = $this->getCampaignsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $external_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCampaignsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $external_id = null)
    {
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\PostCampaigns201Response
     */
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\PostCampaigns201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCampaignWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\PostCampaigns201Response';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\PostCampaigns201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
