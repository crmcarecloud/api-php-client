...
/**
 * CommunicationChannelsApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationChannelsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation getCommunicationChannel
     *
     * Detail of a communication channel
     *
     * @param  string $communication_channel_id The unique ID of the communication channel. (required)
    ...
    {
        list($response) = $this->getCommunicationChannelWithHttpInfo($communication_channel_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCommunicationChannelWithHttpInfo
     *
     * Detail of a communication channel
     *
     * @param  string $communication_channel_id The unique ID of the communication channel. (required)
    ...
    /**
     * Operation getCommunicationChannelAsync
     *
     * Detail of a communication channel
     *
     * @param  string $communication_channel_id The unique ID of the communication channel. (required)
     ...
     */
    public function getCommunicationChannelAsync($communication_channel_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCommunicationChannelAsyncWithHttpInfo($communication_channel_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCommunicationChannelAsyncWithHttpInfo
     *
     * Detail of a communication channel
     *
     * @param  string $communication_channel_id The unique ID of the communication channel. (required)
    ...
    /**
     * Create request for operation 'getCommunicationChannel'
     *
     * @param  string $communication_channel_id The unique ID of the communication channel. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getCommunicationChannelRequest($communication_channel_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'communication_channel_id' is set
        if ($communication_channel_id === null || (is_array($communication_channel_id) && count($communication_channel_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $communication_channel_id when calling getCommunicationChannel'
            );
        }

        $resourcePath = '/communication-channels/{communication_channel_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($communication_channel_id !== null) {
            $resourcePath = str_replace(
                ...
                ObjectSerializer::toPathValue($communication_channel_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getCommunicationChannels
     *
    ...
    /**
     * Operation getCommunicationChannelsWithHttpInfo
     *
     * Get all communication channels
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getCommunicationChannelsAsync
     *
     * Get all communication channels
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getCommunicationChannelsAsyncWithHttpInfo
     *
     * Get all communication channels
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
