<?php
/**
 * CustomerExternalApplicationsApi
 * PHP version 5
 *
 * @category Class
...
/**
 * CustomerExternalApplicationsApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerExternalApplicationsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation getCustomerExternalApp
     *
     * Detail of a customer external application
     *
     * @param  string $customer_external_application_id The unique ID of a customer external application in CareCloud. (required)
    ...
    {
        list($response) = $this->getCustomerExternalAppWithHttpInfo($customer_external_application_id, $accept_language);
        return $response;
    }

    /**
     * Operation getCustomerExternalAppWithHttpInfo
     *
     * Detail of a customer external application
     *
     * @param  string $customer_external_application_id The unique ID of a customer external application in CareCloud. (required)
    ...
    /**
     * Operation getCustomerExternalAppAsync
     *
     * Detail of a customer external application
     *
     * @param  string $customer_external_application_id The unique ID of a customer external application in CareCloud. (required)
     ...
     */
    public function getCustomerExternalAppAsync($customer_external_application_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getCustomerExternalAppAsyncWithHttpInfo($customer_external_application_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerExternalAppAsyncWithHttpInfo
     *
     * Detail of a customer external application
     *
     * @param  string $customer_external_application_id The unique ID of a customer external application in CareCloud. (required)
    ...
    /**
     * Create request for operation 'getCustomerExternalApp'
     *
     * @param  string $customer_external_application_id The unique ID of a customer external application in CareCloud. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getCustomerExternalAppRequest($customer_external_application_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'customer_external_application_id' is set
        if ($customer_external_application_id === null || (is_array($customer_external_application_id) && count($customer_external_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_external_application_id when calling getCustomerExternalApp'
            );
        }

        $resourcePath = '/customer-external-applications/{customer_external_application_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($customer_external_application_id !== null) {
            $resourcePath = str_replace(
                '{' . 'customer_external_application_id' . '}',
                ObjectSerializer::toPathValue($customer_external_application_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getCustomerExternalApps
     *
    ...
    {
        list($response) = $this->getCustomerExternalAppsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction);
        return $response;
    }

    /**
     * Operation getCustomerExternalAppsWithHttpInfo
     *
     * Get all customer external applications
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getCustomerExternalAppsAsync
     *
     * Get all customer external applications
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerExternalAppsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {
        return $this->getCustomerExternalAppsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerExternalAppsAsyncWithHttpInfo
     *
     * Get all customer external applications
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Create request for operation 'getCustomerExternalApps'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomerExternalAppsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null)
    {

        $resourcePath = '/customer-external-applications';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
