...
class CustomerExternalApplicationsApi
{
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApp200Response
     */
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApp200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerExternalAppWithHttpInfo($customer_external_application_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApp200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApp200Response',
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApps200Response
     */
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApps200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApps200Response';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerExternalApps200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
