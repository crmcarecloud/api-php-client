...
class ProductRecommendationEngineApi
{
    ...
    protected function getRecommendationCartCombinedRequest($customer_id, $accept_language = 'cs, en-gb;q=0.8', $cart_product_ids = null, $product_id_list = null, $count = '100')
    {
        ...
        $resourcePath = '/recommendation-engine/shopping-cart/actions/combined';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getRecommendationProductCombined
     *
    ...
    {
        list($response) = $this->getRecommendationProductCombinedWithHttpInfo($customer_id, $accept_language, $product_id_list, $count);
        return $response;
    }

    /**
     * Operation getRecommendationProductCombinedWithHttpInfo
     *
     * Get the best recommendation
     *
     * @param  string $customer_id The unique id of the customer (required)
    ...
    /**
     * Operation getRecommendationProductCombinedAsync
     *
     * Get the best recommendation
     *
     * @param  string $customer_id The unique id of the customer (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRecommendationProductCombinedAsync($customer_id, $accept_language = 'cs, en-gb;q=0.8', $product_id_list = null, $count = '100')
    {
        return $this->getRecommendationProductCombinedAsyncWithHttpInfo($customer_id, $accept_language, $product_id_list, $count)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRecommendationProductCombinedAsyncWithHttpInfo
     *
     * Get the best recommendation
     *
     * @param  string $customer_id The unique id of the customer (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRecommendationProductCombinedRequest($customer_id, $accept_language = 'cs, en-gb;q=0.8', $product_id_list = null, $count = '100')
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null || (is_array($customer_id) && count($customer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_id when calling getRecommendationProductCombined'
            );
        }

        $resourcePath = '/recommendation-engine/product/actions/combined';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
