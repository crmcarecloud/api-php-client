...
class CustomerSourceRecordsApi
{
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerSourceRecord200Response
     */
    public function getCustomerSourceRecords($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null, $customer_source_id = null, $external_ids = null)
    {
        list($response) = $this->getCustomerSourceRecordsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id, $customer_source_id, $external_ids);
        return $response;
    }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerSourceRecord200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerSourceRecordsWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null, $customer_source_id = null, $external_ids = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerSourceRecord200Response';
        $request = $this->getCustomerSourceRecordsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id, $customer_source_id, $external_ids);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerSourceRecord200Response',
     ...
     */
    public function getCustomerSourceRecordsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null, $customer_source_id = null, $external_ids = null)
    {
        return $this->getCustomerSourceRecordsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id, $customer_source_id, $external_ids)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerSourceRecordsAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null, $customer_source_id = null, $external_ids = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetCustomerSourceRecord200Response';
        $request = $this->getCustomerSourceRecordsRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id, $customer_source_id, $external_ids);
     ...
     */
    protected function getCustomerSourceRecordsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null, $customer_source_id = null, $external_ids = null)
    {
