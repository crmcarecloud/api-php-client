 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerSourceRecordsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation getCustomerSourceRecords
     *
    ...
    {
        list($response) = $this->getCustomerSourceRecordsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id, $customer_source_id);
        return $response;
    }

    /**
     * Operation getCustomerSourceRecordsWithHttpInfo
     *
     * Get customer source records
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getCustomerSourceRecordsAsync
     *
     * Get customer source records
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     */
    public function getCustomerSourceRecordsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null, $customer_source_id = null)
    {
        return $this->getCustomerSourceRecordsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id, $customer_source_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerSourceRecordsAsyncWithHttpInfo
     *
     * Get customer source records
     *
    ...
    /**
     * Create request for operation 'getCustomerSourceRecords'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     */
    protected function getCustomerSourceRecordsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null, $customer_source_id = null)
    {

        $resourcePath = '/customer-source-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
