...
/**
 * PointReservationApi Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
...
class PointReservationApi
{
    ...
    /**
     * Operation getPointReservation
     *
     * Get a point reservation
     *
     * @param  string $point_reservation_id The unique ID of the point reservations. (required)
    ...
    {
        list($response) = $this->getPointReservationWithHttpInfo($point_reservation_id, $accept_language);
        return $response;
    }

    /**
     * Operation getPointReservationWithHttpInfo
     *
     * Get a point reservation
     *
     * @param  string $point_reservation_id The unique ID of the point reservations. (required)
    ...
    /**
     * Operation getPointReservationAsync
     *
     * Get a point reservation
     *
     * @param  string $point_reservation_id The unique ID of the point reservations. (required)
     ...
     */
    public function getPointReservationAsync($point_reservation_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->getPointReservationAsyncWithHttpInfo($point_reservation_id, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPointReservationAsyncWithHttpInfo
     *
     * Get a point reservation
     *
     * @param  string $point_reservation_id The unique ID of the point reservations. (required)
    ...
    /**
     * Create request for operation 'getPointReservation'
     *
     * @param  string $point_reservation_id The unique ID of the point reservations. (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     */
    protected function getPointReservationRequest($point_reservation_id, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'point_reservation_id' is set
        if ($point_reservation_id === null || (is_array($point_reservation_id) && count($point_reservation_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $point_reservation_id when calling getPointReservation'
            );
        }

        $resourcePath = '/point-reservations/{point_reservation_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($point_reservation_id !== null) {
            $resourcePath = str_replace(
                '{' . 'point_reservation_id' . '}',
                ObjectSerializer::toPathValue($point_reservation_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getPointReservations
     *
     ...
     * @param  string $external_id The external ID of the point reservation. (optional)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->getPointReservationsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id);
        return $response;
    }

    /**
     * Operation getPointReservationsWithHttpInfo
     *
     * Get all point reservations
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
    ...
    /**
     * Operation getPointReservationsAsync
     *
     * Get all point reservations
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPointReservationsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null)
    {
        return $this->getPointReservationsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $customer_id, $external_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPointReservationsAsyncWithHttpInfo
     *
     * Get all point reservations
     *
     * @param  string|null $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     ...
     * @param  string|null $external_id The external ID of the point reservation. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    ...
    /**
     * Create request for operation 'getPointReservations'
     *
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     * @param  int $count The number of records to return. (optional, default to 100)
     * @param  int $offset The number of records from a collection to skip. (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPointReservationsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $customer_id = null, $external_id = null)
    {

        $resourcePath = '/point-reservations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postPointReservationCreate
     *
     * Create point reservation
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsReservepointsBody $body body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postPointReservationCreate($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->postPointReservationCreateWithHttpInfo($body, $accept_language);
    }

    /**
     * Operation postPointReservationCreateWithHttpInfo
     *
     * Create point reservation
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsReservepointsBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postPointReservationCreateWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postPointReservationCreateRequest($body, $accept_language);
    ...
    /**
     * Operation postPointReservationCreateAsync
     *
     * Create point reservation
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsReservepointsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointReservationCreateAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postPointReservationCreateAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPointReservationCreateAsyncWithHttpInfo
     *
     * Create point reservation
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsReservepointsBody $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointReservationCreateAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postPointReservationCreateRequest($body, $accept_language);
    ...
    /**
     * Create request for operation 'postPointReservationCreate'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsReservepointsBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPointReservationCreateRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postPointReservationCreate'
            );
        }

        $resourcePath = '/point-reservations/actions/reserve-points';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function postPointReservationRelease($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $this->postPointReservationReleaseWithHttpInfo($body, $accept_language);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPointReservationReleaseWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postPointReservationReleaseRequest($body, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointReservationReleaseAsync($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        return $this->postPointReservationReleaseAsyncWithHttpInfo($body, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPointReservationReleaseAsyncWithHttpInfo($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        $returnType = '';
        $request = $this->postPointReservationReleaseRequest($body, $accept_language);
    ...
    /**
     * Create request for operation 'postPointReservationRelease'
     *
     * @param  \CrmCareCloud\Webservice\RestApi\Client\Model\ActionsFreepointsBody $body (required)
     * @param  string $accept_language The unique ID of the language code by ISO 639-1. (optional, default to cs, en-gb;q=0.8)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPointReservationReleaseRequest($body, $accept_language = 'cs, en-gb;q=0.8')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postPointReservationRelease'
            );
        }

        $resourcePath = '/point-reservations/actions/free-points';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
