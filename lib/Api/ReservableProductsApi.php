...
class ReservableProductsApi
{
    ...
    {
        list($response) = $this->getReservableProductsWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReservableProductsAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null)
    {
        return $this->getReservableProductsAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $name, $code)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getReservableProductsRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $name = null, $code = null)
    {
