...
class PurchaseTypesApi
{
     ...
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseTypes200Response
     */
    public function getPurchaseTypes($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        list($response) = $this->getPurchaseTypesWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id);
        return $response;
    }
     ...
     * @throws \CrmCareCloud\Webservice\RestApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseTypes200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPurchaseTypesWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseTypes200Response';
        $request = $this->getPurchaseTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseTypes200Response',
     ...
     */
    public function getPurchaseTypesAsync($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        return $this->getPurchaseTypesAsyncWithHttpInfo($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPurchaseTypesAsyncWithHttpInfo($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
        $returnType = '\CrmCareCloud\Webservice\RestApi\Client\Model\GetPurchaseTypes200Response';
        $request = $this->getPurchaseTypesRequest($accept_language, $count, $offset, $sort_field, $sort_direction, $text_id);
     ...
     */
    protected function getPurchaseTypesRequest($accept_language = 'cs, en-gb;q=0.8', $count = '100', $offset = '0', $sort_field = null, $sort_direction = null, $text_id = null)
    {
