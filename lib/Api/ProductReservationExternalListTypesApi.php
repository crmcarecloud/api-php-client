...
class ProductReservationExternalListTypesApi
{
     ...
     *
     * @param  string $product_reservation_external_list_type_id Every reservation can have more than one external code depends of the business requirements. This parameter allows to pick from witch list of external codes you want to choose. (required)
