 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreditType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreditType';
...
'last_change' => 'getLastChange'    ];
     ...
     * Sets credit_type_id
     *
     * @param string $credit_type_id The unique ID of the credit type.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the credit type.
     *
     * @return $this
     */
