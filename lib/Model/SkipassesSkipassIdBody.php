 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SkipassesSkipassIdBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'skipasses_skipass_id_body';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['skipass'] === null) {
            $invalidProperties[] = "'skipass' can't be null";
        }
