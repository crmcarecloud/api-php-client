...
'comunication_channel_id' => 'comunication_channel_id',
...
'comunication_channel_id' => 'setComunicationChannelId',
...
'comunication_channel_id' => 'getComunicationChannelId',
...
self::COMUNICATION_CHANNEL_ID__5,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['comunication_channel_id'] = isset($data['comunication_channel_id']) ? $data['comunication_channel_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['comunication_channel_id'] === null) {
            $invalidProperties[] = "'comunication_channel_id' can't be null";
        }
        $allowedValues = $this->getComunicationChannelIdAllowableValues();
        if (!is_null($this->container['comunication_channel_id']) && !in_array($this->container['comunication_channel_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'comunication_channel_id', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param bool $consent_free_template If true, customer can recieve message without any consent(GDPR, etc.)
     *
     * @return $this
     */
    ...
    {
        return $this->container['comunication_channel_id'];
    }
     ...
     * @return $this
     */
    public function setComunicationChannelId($comunication_channel_id)
    {
        $allowedValues = $this->getComunicationChannelIdAllowableValues();
        if (!in_array($comunication_channel_id, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'comunication_channel_id', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['comunication_channel_id'] = $comunication_channel_id;
