...
/**
 * GetSubPartnerProperties200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetSubPartnerProperties200ResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSubPartnerProperties200Response_data';
     ...
     * Sets total_items
     *
     * @param int $total_items The number of all found partner property records.
     *
     * @return $this
     */
