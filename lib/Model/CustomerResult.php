 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerResult';
...
'match' => 'getMatch'    ];
     ...
     * Sets match
     *
     * @param int $match Percentage of match of the search parameters
     *
     * @return $this
     */
