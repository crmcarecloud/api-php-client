...
/**
 * ProductReservationSource Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductReservationSource implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductReservationSource';
...
self::STATE_2,        ];
     ...
     * Sets name
     *
     * @param string $name Name of the product reservation source in defined language(depends on language in http header of the API request).
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param int $state State of the product reservation source. *Possible values are: 0 - deleted / 1 - active *
     *
     * @return $this
     */
