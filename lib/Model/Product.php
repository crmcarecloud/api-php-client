...
self::STATE_2,        ];
     ...
     * Sets external_id
     *
     * @param string $external_id The external unique id of the product. This parameter is depracated. Please use parameter `plu_ids`
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param int $state State of the product *Possible values are: 0 - deleted / 1 - active / 2 - non active*
     *
     * @return $this
     */
