...
/**
 * ActionsVerifyauthtokenBody1 Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsVerifyauthtokenBody1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_verifyauthtoken_body_1';
     ...
     * Sets auth_token
     *
     * @param string $auth_token Authentication token for user verification
     *
     * @return $this
     */
