...
self::AGREEMENT_MARKETING_COMMUNICATION_2,        ];
     ...
     * Sets agreement_gtc
     *
     * @param int $agreement_gtc Consent to the Personal data processing. *Possible values: 0 - no, consent canceled / 1 - yes, consent given / 2 - consent not set*
     *
     * @return $this
     */
     ...
     *
     * @param int $agreement_profiling Consent to the Profiling. *Possible values: 0 - no, consent canceled / 1 - yes, consent given / 2 - consent not set*
     *
     * @return $this
     */
     ...
     *
     * @param int $agreement_marketing_communication Consent to the Marketing communication. *Possible values: 0 - no, consent canceled / 1 - yes, consent given / 2 - consent not set*
     *
     * @return $this
     */
     ...
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\CustomAgreements[] $custom_agreements Custom consent list. The list of consents is available in the [Consents resource](https://carecloud.readme.io/reference/getconsents)
     *
     * @return $this
     */
