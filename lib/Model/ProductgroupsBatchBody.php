...
/**
 * ProductgroupsBatchBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductgroupsBatchBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productgroups_batch_body';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_groups'] === null) {
            $invalidProperties[] = "'product_groups' can't be null";
        }
     ...
     * Sets product_groups
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\ProductGroup[] $product_groups List of the CareCloud product groups.
     *
     * @return $this
     */
