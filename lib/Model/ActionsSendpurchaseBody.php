 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsSendpurchaseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_sendpurchase_body';
...
'bill' => 'getBill'    ];
     ...
     *
     * @param int $cashdesk_number Number of the cash-desk in store.
     *
     * @return $this
     */
