...
class InlineResponse20022Data implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'segment_records' => '\CareCloud\Model\SegmentRecord[]',
'total_items' => 'int'    ];
...
'total_items' => 'getTotalItems'    ];
     ...
     *
     * @return \CareCloud\Model\SegmentRecord[]
     */
     ...
     *
     * @param \CareCloud\Model\SegmentRecord[] $segment_records List of segment records
     *
     * @return $this
     */
     ...
     * Sets total_items
     *
     * @param int $total_items Count of all found segment records
     *
     * @return $this
     */
