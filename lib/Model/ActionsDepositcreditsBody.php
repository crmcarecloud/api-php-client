...
/**
 * ActionsDepositcreditsBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsDepositcreditsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_depositcredits_body';
     ...
     * Sets amount
     *
     * @param float $amount The number of deposit credits.
     *
     * @return $this
     */
     ...
     * Sets credit_type_id
     *
     * @param string $credit_type_id The unique ID of the credit type. If the parameter is not set, a default credit type is set.
     *
     * @return $this
     */
     ...
     * Sets note
     *
     * @param string $note Note for the new credit deposit.
     *
     * @return $this
     */
