<?php
/**
 * PropertyrecordsPropertyRecordIdBody1
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PropertyrecordsPropertyRecordIdBody1 Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PropertyrecordsPropertyRecordIdBody1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'propertyrecords_property_record_id_body_1';
    ...
    protected static $setters = [
        'property_record' => 'setPropertyRecord'    ];
    ...
    protected static $getters = [
        'property_record' => 'getPropertyRecord'    ];
    ...
    {
        $this->container['property_record'] = isset($data['property_record']) ? $data['property_record'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['property_record'] === null) {
            $invalidProperties[] = "'property_record' can't be null";
        }
    ...
    {
        return $this->container['property_record'];
    }
     ...
     * @return $this
     */
    public function setPropertyRecord($property_record)
    {
        $this->container['property_record'] = $property_record;
