...
class InlineResponse20010Data implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'card_types' => '\CareCloud\Model\CardType[]',
'total_items' => 'int'    ];
...
'total_items' => 'getTotalItems'    ];
     ...
     * Sets card_types
     *
     * @param \CareCloud\Model\CardType[] $card_types Collection of all card types
     *
     * @return $this
     */
     ...
     * Sets total_items
     *
     * @param int $total_items Count of all found card types
     *
     * @return $this
     */
