...
/**
 * ActionsApplyvoucherBody Class Doc Comment
 *
 * @category Class
 * @package  CareCloud
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsApplyvoucherBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_applyvoucher_body';
...
'date_applied' => 'getDateApplied'    ];
     ...
     * Sets date_applied
     *
     * @param string $date_applied Date (ISO 8601) of voucher application *(YYYY-MM-DD HH:MM:SS)*
     *
     * @return $this
     */
