 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RewardType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RewardType';
...
'last_change' => 'getLastChange'    ];
     ...
     * Sets reward_type_id
     *
     * @param string $reward_type_id The unique ID of the reward type.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the reward type.
     *
     * @return $this
     */
