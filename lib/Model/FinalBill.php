...
self::PAYMENT_TYPE_D,        ];
     ...
     *
     * @param int $purchase_type_id Type of the purchase. Values are available in resource [purchase-types](#tag/Purchase-types)
     *
     * @return $this
     */
     ...
     * Sets payment_type
     *
     * @param string $payment_type The method of the bill closure. *Possible values are: “S” - standard / “P”- use points for payment / “C” - use credits for payment / “D”- use discount now*
     *
     * @return $this
     */
