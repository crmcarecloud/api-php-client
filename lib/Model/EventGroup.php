 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EventGroup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EventGroup';
...
self::STATE_2,        ];
     ...
     * Sets event_group_id
     *
     * @param string $event_group_id The unique ID of the event.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The unique ID of the event type.
     *
     * @return $this
     */
     ...
     * Sets text_id
     *
     * @param string $text_id Text ID of an event group.
     *
     * @return $this
     */
