...
/**
 * ActionsVerifycredentialsBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsVerifycredentialsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_verifycredentials_body';
...
self::LOGIN_TYPE_EMAIL,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['login_value'] = isset($data['login_value']) ? $data['login_value'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['login_type'] === null) {
            $invalidProperties[] = "'login_type' can't be null";
        }
        ...
        if ($this->container['login_value'] === null) {
            $invalidProperties[] = "'login_value' can't be null";
        }
     ...
     * Sets login_type
     *
     * @param string $login_type The unique ID of the login type (available: card, email).
     *
     * @return $this
     */
    ...
    {
        return $this->container['login_value'];
    }

    /**
     * Sets login_value
     *
     * @param string $login_value Value of the login for customer interface API.
     *
     * @return $this
     */
    public function setLoginValue($login_value)
    {
        $this->container['login_value'] = $login_value;
