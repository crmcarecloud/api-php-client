...
'customer_id' => 'string',
'product' => '\CrmCareCloud\Webservice\RestApi\Client\Model\ProductIdentification',
...
self::STATE_2,        ];
     ...
     * Sets customer_id
     *
     * @param string $customer_id The unique id of the CareCloud customer. Required only if `product_id` is not set.
     *
     * @return $this
     */
     ...
     * Sets product
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\ProductIdentification $product product
     *
     * @return $this
     */
