...
/**
 * ActionsLoginBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsLoginBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_login_body';
...
self::LOGIN_TYPE_EMAIL,        ];
     ...
     * Sets login_value
     *
     * @param string $login_value Value of the login to Customer interface API.
     *
     * @return $this
     */
