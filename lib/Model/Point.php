...
'assigned_points' => 'setAssignedPoints',
...
'assigned_points' => 'getAssignedPoints',
...
self::STATE_2,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['assigned_points'] = isset($data['assigned_points']) ? $data['assigned_points'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['point_type_id'] === null) {
            $invalidProperties[] = "'point_type_id' can't be null";
        }
    ...
    /**
     * Gets assigned_points
     *
     * @return float
     */
    public function getAssignedPoints()
    {
        return $this->container['assigned_points'];
    }

    /**
     * Sets assigned_points
     *
     * @param float $assigned_points The number of earned points.
     *
     * @return $this
     */
    public function setAssignedPoints($assigned_points)
    {
        $this->container['assigned_points'] = $assigned_points;
     ...
     *
     * @param float $available_points The number of points available actually taking into account the eventual points redemption.
     *
     * @return $this
     */
     ...
     * Sets valid_to
     *
     * @param string $valid_to Date and time of the point record validity to. *(YYYY-MM-DD HH:MM:SS)*
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param int $state State of the point record. *Possible values are: 0 - deleted / 1 - active / 2 - non active*
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string $created_at Date and time of point record creation. *Possible value: 2016-06-30T15:51:49+02:00*
     *
     * @return $this
     */
