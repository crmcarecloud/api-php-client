...
'customer_id' => 'string',
'external_id' => 'string',
'data' => '\CareCloud\Model\AnyOfEventData',
'created_at' => 'string',
...
self::STATE_2,        ];
     ...
     * Gets data
     *
     * @return \CareCloud\Model\AnyOfEventData
     */
     ...
     * Sets data
     *
     * @param \CareCloud\Model\AnyOfEventData $data Additional data of the event. Serialized data in JSON
     *
     * @return $this
     */
