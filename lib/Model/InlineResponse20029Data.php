...
class InlineResponse20029Data implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_29_data';
    ...
    protected static $swaggerTypes = [
        'customer_types' => '\CareCloud\Model\CustomerType[]',
'total_items' => 'int'    ];
...
'total_items' => 'getTotalItems'    ];
     ...
     * Gets customer_types
     *
     * @return \CareCloud\Model\CustomerType[]
     */
     ...
     * Sets customer_types
     *
     * @param \CareCloud\Model\CustomerType[] $customer_types List of the customer types
     *
     * @return $this
     */
