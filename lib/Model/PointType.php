 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PointType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PointType';
...
'last_change' => 'getLastChange'    ];
     ...
     * Sets point_type_id
     *
     * @param string $point_type_id The unique ID of the point type.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the point type.
     *
     * @return $this
     */
