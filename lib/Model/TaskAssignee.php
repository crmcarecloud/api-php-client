...
/**
 * TaskAssignee Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaskAssignee implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaskAssignee';
...
'last_change' => 'getLastChange'    ];
     ...
     *
     * @param string $task_assignee_id The unique ID of the task assignee.
     *
     * @return $this
     */
     ...
     * Sets user_id
     *
     * @param string $user_id The unique ID of the assigned user.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the assigned user.
     *
     * @return $this
     */
