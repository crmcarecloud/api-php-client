 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductreservationsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productreservations_body';
    ...
    protected static $setters = [
        'product_reservation' => 'setProductReservation'    ];
    ...
    protected static $getters = [
        'product_reservation' => 'getProductReservation'    ];
    ...
    {
        $this->container['product_reservation'] = isset($data['product_reservation']) ? $data['product_reservation'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_reservation'] === null) {
            $invalidProperties[] = "'product_reservation' can't be null";
        }
    ...
    {
        return $this->container['product_reservation'];
    }
     ...
     * @return $this
     */
    public function setProductReservation($product_reservation)
    {
        $this->container['product_reservation'] = $product_reservation;
