 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignproductsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'campaignproducts_body';
    ...
    protected static $setters = [
        'campaign_product' => 'setCampaignProduct'    ];
    ...
    protected static $getters = [
        'campaign_product' => 'getCampaignProduct'    ];
    ...
    {
        $this->container['campaign_product'] = isset($data['campaign_product']) ? $data['campaign_product'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['campaign_product'] === null) {
            $invalidProperties[] = "'campaign_product' can't be null";
        }
    ...
    {
        return $this->container['campaign_product'];
    }
     ...
     * @return $this
     */
    public function setCampaignProduct($campaign_product)
    {
        $this->container['campaign_product'] = $campaign_product;
