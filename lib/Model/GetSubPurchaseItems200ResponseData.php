<?php
/**
 * GetSubPurchaseItems200ResponseData
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GetSubPurchaseItems200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetSubPurchaseItems200ResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSubPurchaseItems200Response_data';
     ...
     * Sets total_items
     *
     * @param int $total_items The number of all found purchase items.
     *
     * @return $this
     */
