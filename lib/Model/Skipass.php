 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Skipass implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Skipass';
...
'external_skipass_id' => null,
'skipass_type_id' => null,
'order_item_id' => null,
'card_id' => null,
'created_at' => null,
'cancelled_at' => null,
...
'external_skipass_id' => 'external_skipass_id',
'skipass_type_id' => 'skipass_type_id',
...
const STATE_1 = 1;
     ...
     * @return string[]
     */
    public function getSkipassTypeIdAllowableValues()
    {
        return [
            self::SKIPASS_TYPE_ID_0,
self::SKIPASS_TYPE_ID_1,
self::SKIPASS_TYPE_ID_2,        ];
    }
    /**
     * Gets allowable values of the enum
     *
...
self::STATE_1,        ];
    ...
    {
        $this->container['skipass_id'] = isset($data['skipass_id']) ? $data['skipass_id'] : null;
        ...
        $this->container['external_skipass_id'] = isset($data['external_skipass_id']) ? $data['external_skipass_id'] : null;
        $this->container['skipass_type_id'] = isset($data['skipass_type_id']) ? $data['skipass_type_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['skipass_id'] === null) {
            $invalidProperties[] = "'skipass_id' can't be null";
        }
        if ($this->container['skipass_type_id'] === null) {
            $invalidProperties[] = "'skipass_type_id' can't be null";
        }
        $allowedValues = $this->getSkipassTypeIdAllowableValues();
        if (!is_null($this->container['skipass_type_id']) && !in_array($this->container['skipass_type_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'skipass_type_id', must be one of '%s'",
     ...
     * @return string
     */
    public function getSkipassId()
    {
        return $this->container['skipass_id'];
    }

    /**
     * Sets skipass_id
     *
     * @param string $skipass_id The unique id of the skipass
     *
     * @return $this
     */
    public function setSkipassId($skipass_id)
    {
        $this->container['skipass_id'] = $skipass_id;
     ...
     * Sets name
     *
     * @param string $name Name of the skipass
     *
     * @return $this
     */
     ...
     * Sets resort_name
     *
     * @param string $resort_name Name of the resort where is a skipass charged
     *
     * @return $this
     */
    ...
    /**
     * Gets external_skipass_id
     *
     * @return string
     */
    public function getExternalSkipassId()
    {
        return $this->container['external_skipass_id'];
    }

    /**
     * Sets external_skipass_id
     *
     * @param string $external_skipass_id External id of skipass. Structure can be different depends of POS system, that created skipass
     *
     * @return $this
     */
    public function setExternalSkipassId($external_skipass_id)
    {
        $this->container['external_skipass_id'] = $external_skipass_id;

        return $this;
    }

    /**
     * Gets skipass_type_id
     *
     * @return int
     */
    public function getSkipassTypeId()
    {
        return $this->container['skipass_type_id'];
    }

    /**
     * Sets skipass_type_id
     *
     * @param int $skipass_type_id Type of the skipass *Possible values are: season ticket - 0/ one day ticket -1/ multiple day ticket - 2*
     *
     * @return $this
     */
    public function setSkipassTypeId($skipass_type_id)
    {
        $allowedValues = $this->getSkipassTypeIdAllowableValues();
        if (!in_array($skipass_type_id, $allowedValues, true)) {
        ...
        $this->container['skipass_type_id'] = $skipass_type_id;
     ...
     * Sets order_item_id
     *
     * @param string $order_item_id Order id item represents relation between skipass and order item from carecloud e-shop
     *
     * @return $this
     */
     ...
     * Sets card_id
     *
     * @param string $card_id Id of card used for charge skipasses
     *
     * @return $this
     */
     ...
     * Sets charge_date
     *
     * @param string $charge_date Date and time when skipass will be charged to the POS system *(YYYY-MM-DD HH:MM:SS)*
     *
     * @return $this
     */
     ...
     * Sets valid_from
     *
     * @param string $valid_from Date of the first day when customer can use skipass *(YYYY-MM-DD)*
     *
     * @return $this
     */
     ...
     * Sets valid_to
     *
     * @param string $valid_to Date of the last day when customer can use skipass *(YYYY-MM-DD)*
     *
     * @return $this
     */
