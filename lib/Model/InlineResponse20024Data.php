...
class InlineResponse20024Data implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'recommendation_records' => '\CrmCareCloud\Webservice\RestApi\Client\Model\Recommendation[]',
'total_items' => 'int'    ];
...
'total_items' => 'total_items'    ];
    ...
    protected static $setters = [
        'recommendation_records' => 'setRecommendationRecords',
'total_items' => 'setTotalItems'    ];
    ...
    protected static $getters = [
        'recommendation_records' => 'getRecommendationRecords',
'total_items' => 'getTotalItems'    ];
    ...
    {
        $this->container['recommendation_records'] = isset($data['recommendation_records']) ? $data['recommendation_records'] : null;
    ...
    /**
     * Gets recommendation_records
     *
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\Recommendation[]
     */
    public function getRecommendationRecords()
    {
        return $this->container['recommendation_records'];
    }

    /**
     * Sets recommendation_records
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\Recommendation[] $recommendation_records List of Recomendation records
     *
     * @return $this
     */
    public function setRecommendationRecords($recommendation_records)
    {
        $this->container['recommendation_records'] = $recommendation_records;
