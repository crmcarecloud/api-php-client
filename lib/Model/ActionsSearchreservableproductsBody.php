<?php
/**
 * ActionsSearchreservableproductsBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ActionsSearchreservableproductsBody Class Doc Comment
 *
 * @category Class
 * @package  CareCloud
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsSearchreservableproductsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_searchreservableproducts_body';
     ...
     * Sets search_string
     *
     * @param string $search_string String used for searching the results
     *
     * @return $this
     */
