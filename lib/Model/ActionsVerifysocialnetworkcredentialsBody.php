<?php
/**
 * ActionsVerifysocialnetworkcredentialsBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ActionsVerifysocialnetworkcredentialsBody Class Doc Comment
 *
 * @category Class
 * @package  CareCloud
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsVerifysocialnetworkcredentialsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_verifysocialnetworkcredentials_body';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['social_network_credentials'] === null) {
            $invalidProperties[] = "'social_network_credentials' can't be null";
        }
