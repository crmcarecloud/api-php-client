...
/**
 * BookingStatus Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BookingStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BookingStatus';
...
'last_change' => 'last_change'    ];
    ...
    protected static $setters = [
        'booking_status_id' => 'setBookingStatusId',
'name' => 'setName',
...
'last_change' => 'setLastChange'    ];
    ...
    protected static $getters = [
        'booking_status_id' => 'getBookingStatusId',
'name' => 'getName',
...
self::STATE_1,        ];
    ...
    {
        $this->container['booking_status_id'] = isset($data['booking_status_id']) ? $data['booking_status_id'] : null;
    ...
    /**
     * Gets booking_status_id
     *
     * @return string
     */
    public function getBookingStatusId()
    {
        return $this->container['booking_status_id'];
    }

    /**
     * Sets booking_status_id
     *
     * @param string $booking_status_id The unique ID of the booking status.
     *
     * @return $this
     */
    public function setBookingStatusId($booking_status_id)
    {
        $this->container['booking_status_id'] = $booking_status_id;
     ...
     * Sets name
     *
     * @param string $name Name of the booking status in language from request header.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string $created_at Date and time of booking status creation. *(YYYY-MM-DD HH:MM:SS)*
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param int $state State of the booking status. *Possible values are: 0 - blocked / 1 - active*
     *
     * @return $this
     */
