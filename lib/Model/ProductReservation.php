...
self::STATE_2,        ];
     ...
     * Sets benefit_codes
     *
     * @param string[] $benefit_codes List of the benefit (rewards, vouchers) codes used in a reservation. After the reservation is delivered, all benefits are applied on the customer's account
     *
     * @return $this
     */
     ...
     * Sets total_price
     *
     * @param float $total_price Total price of reservation If currency_id, than total_price is mandatory
     *
     * @return $this
     */
     ...
     * Sets currency_id
     *
     * @param string $currency_id Id of the currency. If total_price is set, than currency_id is mandatory
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param int $state State of the product reservation *Possible values are: 0 - deleted / 1 - active / 2 - non active*
     *
     * @return $this
     */
