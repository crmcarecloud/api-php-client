...
self::STATE_2,        ];
     ...
     * Sets states
     *
     * @param string[] $states History of the state values. States are sorted in descending order by time
     *
     * @return $this
     */
     ...
     * Sets comments
     *
     * @param string[] $comments Reservation comments. Comments are sorted in descending order by time
     *
     * @return $this
     */
