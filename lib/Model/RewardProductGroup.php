...
/**
 * RewardProductGroup Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RewardProductGroup extends ProductGroup 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RewardProductGroup';
     ...
     *
     * @param string[] $reward_product_relation_types Parameter identify type of the relation between reward and product group.  *Possible values are: `condition` - product group is part of a reward condition / `bonus` - product group is part of a reward condition*
     *
     * @return $this
     */
