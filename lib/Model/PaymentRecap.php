...
'recommended_discounts' => 'getRecommendedDiscounts'    ];
     ...
     * Sets credit_points
     *
     * @param float $credit_points Amount of the points used for payment of the bill
     *
     * @return $this
     */
     ...
     *
     * @param float $amount_for_credit Amount of the credits used for payment of the bill
     *
     * @return $this
     */
