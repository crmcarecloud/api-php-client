...
self::PAYMENT_TYPE_D,        ];
     ...
     * Sets payment_type
     *
     * @param string $payment_type Method of the bill closure *Possible values: “S”-standard / “D”- use discount now*
     *
     * @return $this
     */
     ...
     * Sets max_credit
     *
     * @param string $max_credit Amount of credits to be used
     *
     * @return $this
     */
