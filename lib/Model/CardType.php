 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CardType';
...
'prefix' => 'getPrefix'    ];
     ...
     * Sets name
     *
     * @param string $name Name of the card type.
     *
     * @return $this
     */
     ...
     * Sets prefix
     *
     * @param string $prefix Prefix of the specific card type cards.
     *
     * @return $this
     */
