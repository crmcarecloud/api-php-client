...
/**
 * ProductbrandsBatchBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductbrandsBatchBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productbrands_batch_body';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_brands'] === null) {
            $invalidProperties[] = "'product_brands' can't be null";
        }
     ...
     * Sets product_brands
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\ProductBrand[] $product_brands List of the CareCloud product brands.
     *
     * @return $this
     */
