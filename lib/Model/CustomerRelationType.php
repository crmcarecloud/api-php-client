...
/**
 * CustomerRelationType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerRelationType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerRelationType';
...
self::STATE_2,        ];
     ...
     * Sets name
     *
     * @param string $name Name of the customer relation type
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param int $state State of the customer relation type. *Possible values are: 0 - deleted / 1 - active / 2 - non active*
     *
     * @return $this
     */
