...
/**
 * StamperCondition Class Doc Comment
 *
 * @category Class
 * @description Stamper condition resource.
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StamperCondition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StamperCondition';
     ...
     *
     * @param string $stamper_condition_id The unique ID of the stamper condition.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Stamper condition description. The translation is return depending on the language value in the HTTP request header Accept-Language.
     *
     * @return $this
     */
