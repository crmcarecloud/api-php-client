...
/**
 * SocialNetworkCredentials Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialNetworkCredentials implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialNetworkCredentials';
...
'social_network_token' => 'social_network_token'    ];
    ...
    protected static $setters = [
        'social_network_id' => 'setSocialNetworkId',
'social_network_token' => 'setSocialNetworkToken'    ];
    ...
    protected static $getters = [
        'social_network_id' => 'getSocialNetworkId',
'social_network_token' => 'getSocialNetworkToken'    ];
    ...
    {
        $this->container['social_network_id'] = isset($data['social_network_id']) ? $data['social_network_id'] : null;
        $this->container['social_network_token'] = isset($data['social_network_token']) ? $data['social_network_token'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['social_network_id'] === null) {
            $invalidProperties[] = "'social_network_id' can't be null";
        }
        if ($this->container['social_network_token'] === null) {
            $invalidProperties[] = "'social_network_token' can't be null";
        }
    ...
    /**
     * Gets social_network_id
     *
     * @return string
     */
    public function getSocialNetworkId()
    {
        return $this->container['social_network_id'];
    }

    /**
     * Sets social_network_id
     *
     * @param string $social_network_id The unique id of the social network
     *
     * @return $this
     */
    public function setSocialNetworkId($social_network_id)
    {
        $this->container['social_network_id'] = $social_network_id;

        return $this;
    }

    /**
     * Gets social_network_token
     *
     * @return string
     */
    public function getSocialNetworkToken()
    {
        return $this->container['social_network_token'];
    }

    /**
     * Sets social_network_token
     *
     * @param string $social_network_token Social network customer's token
     *
     * @return $this
     */
    public function setSocialNetworkToken($social_network_token)
    {
        $this->container['social_network_token'] = $social_network_token;
