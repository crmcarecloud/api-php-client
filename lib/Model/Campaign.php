...
self::STATE_2,        ];
     ...
     * Sets idcampaign
     *
     * @param string $idcampaign The unique ID of the campaign.  ⚠️ This parameter is deprecated, please use `campaign_id` instead. Please be aware this parameter can be referred in different endpoints as `campaign_id`.
     *
     * @return $this
     */
