 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BasicError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BasicError';
...
'detail' => 'getDetail'    ];
     ...
     * Sets exception
     *
     * @param string $exception Content of the exception.
     *
     * @return $this
     */
     ...
     * Sets detail
     *
     * @param string $detail The details of the error message.
     *
     * @return $this
     */
