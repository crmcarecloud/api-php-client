...
/**
 * ActionsTransferpointsBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsTransferpointsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_transferpoints_body';
...
'point_type_id' => 'getPointTypeId'    ];
     ...
     *
     * @param string $original_customer_id ID of the original points holder.
     *
     * @return $this
     */
     ...
     *
     * @param string $new_customer_id ID of the new points holder.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float $amount Number of the transferred points.
     *
     * @return $this
     */
     ...
     * Sets point_type_id
     *
     * @param string $point_type_id Type of the transferred points.
     *
     * @return $this
     */
