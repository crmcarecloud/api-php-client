...
/**
 * ActionsLoginBody1 Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsLoginBody1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_login_body_1';
...
'password' => 'getPassword'    ];
     ...
     * Sets login
     *
     * @param string $login Login name of user in CareCloud.
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string $password The CareCloud user password.
     *
     * @return $this
     */
