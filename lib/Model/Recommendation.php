...
self::STATE_2,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['picture_urls'] = isset($data['picture_urls']) ? $data['picture_urls'] : null;
     ...
     * Sets name
     *
     * @param string $name Name of a the recommendation.
     *
     * @return $this
     */
     ...
     *
     * @param string $brief_description Brief description of the recommendation.
     *
     * @return $this
     */
     ...
     *
     * @param string $detailed_description Detailed recommendation description.
     *
     * @return $this
     */
     ...
     * Sets content
     *
     * @param string $content Content of the recommendation as a text.
     *
     * @return $this
     */
    ...
    {
        return $this->container['picture_urls'];
    }

    /**
     * Sets picture_urls
     *
     * @param string[] $picture_urls URL addresses of the pictures of the recommendation.
     *
     * @return $this
     */
    public function setPictureUrls($picture_urls)
    {
        $this->container['picture_urls'] = $picture_urls;
     ...
     * Sets web_url
     *
     * @param string $web_url URL address of the recommendation website.
     *
     * @return $this
     */
