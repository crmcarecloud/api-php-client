...
/**
 * CardsCardIdBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardsCardIdBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'cards_card_id_body';
    ...
    protected static $swaggerTypes = [
        'card' => '\CrmCareCloud\Webservice\RestApi\Client\Model\Card'    ];
     ...
     * Sets card
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\Card $card card
     *
     * @return $this
     */
