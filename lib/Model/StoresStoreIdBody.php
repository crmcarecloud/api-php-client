...
/**
 * StoresStoreIdBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoresStoreIdBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'stores_store_id_body';
    ...
    protected static $swaggerTypes = [
        'store' => '\CrmCareCloud\Webservice\RestApi\Client\Model\Store'    ];
     ...
     * Sets store
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\Store $store store
     *
     * @return $this
     */
