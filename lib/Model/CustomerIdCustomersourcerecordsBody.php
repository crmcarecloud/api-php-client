<?php
/**
 * CustomerIdCustomersourcerecordsBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CustomerIdCustomersourcerecordsBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerIdCustomersourcerecordsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'customer_id_customersourcerecords_body';
    ...
    protected static $swaggerTypes = [
        'customer_source_record' => '\CrmCareCloud\Webservice\RestApi\Client\Model\CustomerSourceRecord'    ];
    ...
    protected static $attributeMap = [
        'customer_source_record' => 'customer_source_record'    ];
    ...
    protected static $setters = [
        'customer_source_record' => 'setCustomerSourceRecord'    ];
    ...
    protected static $getters = [
        'customer_source_record' => 'getCustomerSourceRecord'    ];
    ...
    {
        $this->container['customer_source_record'] = isset($data['customer_source_record']) ? $data['customer_source_record'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_source_record'] === null) {
            $invalidProperties[] = "'customer_source_record' can't be null";
        }
    ...
    /**
     * Gets customer_source_record
     *
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\CustomerSourceRecord
     */
    public function getCustomerSourceRecord()
    {
        return $this->container['customer_source_record'];
    }

    /**
     * Sets customer_source_record
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\CustomerSourceRecord $customer_source_record customer_source_record
     *
     * @return $this
     */
    public function setCustomerSourceRecord($customer_source_record)
    {
        $this->container['customer_source_record'] = $customer_source_record;
