...
class ProductreservationpricesBatchBody1 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'product_reservation_prices' => '\CrmCareCloud\Webservice\RestApi\Client\Model\ProductreservationpricesbatchProductReservationPrices[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_reservation_prices'] === null) {
            $invalidProperties[] = "'product_reservation_prices' can't be null";
        }
     ...
     *
     * @return \CrmCareCloud\Webservice\RestApi\Client\Model\ProductreservationpricesbatchProductReservationPrices[]
     */
     ...
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\ProductreservationpricesbatchProductReservationPrices[] $product_reservation_prices List of the product reservation prices.
     *
     * @return $this
     */
