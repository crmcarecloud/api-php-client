 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UTM implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UTM';
...
'utm_campaign' => 'getUtmCampaign'    ];
     ...
     * Sets utm_source
     *
     * @param string $utm_source Use utm_source to identify a search engine, newsletter name, or other sources. (Example: google).
     *
     * @return $this
     */
     ...
     * Sets utm_medium
     *
     * @param string $utm_medium Use utm_medium to identify a medium such as an email or cost-per-click. (Example: cpc).
     *
     * @return $this
     */
     ...
     * Sets utm_campaign
     *
     * @param string $utm_campaign Used for keyword analysis. Use utm_campaign to identify a specific product promotion or strategic campaign. (Example: utm_campaign=spring_sale).
     *
     * @return $this
     */
