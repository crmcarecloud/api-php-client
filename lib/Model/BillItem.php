...
'customer_id' => 'getCustomerId'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['category_plu_id'] === null) {
            $invalidProperties[] = "'category_plu_id' can't be null";
        }
     ...
     * Sets price
     *
     * @param float $price Value of parameter \"paid_amount\". In the case of a pharmaceutical client, add to the value of \"paid_amount\" a value of money covered by the customer's health insurance.
     *
     * @return $this
     */
