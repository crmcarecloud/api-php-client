...
/**
 * ActionsFreepointsBody Class Doc Comment
 *
 * @category Class
 * @package  CareCloud
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsFreepointsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_freepoints_body';
     ...
     * Sets external_id
     *
     * @param string $external_id The external id of the point reservation.
     *
     * @return $this
     */
