...
'state' => 'getState'    ];
    ...
    const BOOKING_STATUS_0 = 0;
const BOOKING_STATUS_1 = 1;
const BOOKING_STATUS_2 = 2;
const STATE_0 = 0;
const STATE_1 = 1;
const STATE_2 = 2;
    ...
    {
        return [
            self::BOOKING_STATUS_0,
self::BOOKING_STATUS_1,
self::BOOKING_STATUS_2,        ];
    }
    /**
     * Gets allowable values of the enum
     *
...
self::STATE_2,        ];
     ...
     * Sets booking_items
     *
     * @param \CrmCareCloud\Webservice\RestApi\Client\Model\BookingItem[] $booking_items List of the booking items. Included only if query parameter `add_booking_items` is `true`
     *
     * @return $this
     */
     ...
     * Sets booking_status
     *
     * @param int $booking_status Current status of the booking *Possible values: 0 - created and not used / 1 - used / 2 - canceled*
     *
     * @return $this
     */
