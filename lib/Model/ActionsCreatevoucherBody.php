...
/**
 * ActionsCreatevoucherBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsCreatevoucherBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_createvoucher_body';
...
'note' => 'getNote'    ];
     ...
     * Sets note
     *
     * @param string $note The voucher note.
     *
     * @return $this
     */
