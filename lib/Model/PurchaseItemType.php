...
/**
 * PurchaseItemType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PurchaseItemType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Purchase-item-type';
...
'name' => 'getName'    ];
     ...
     * Sets type_id
     *
     * @param string $type_id The unique id of the purchase item type
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the purchase item type
     *
     * @return $this
     */
