...
'value' => 'getValue'    ];
    ...
    {
        $this->container['external_code_type_id'] = isset($data['external_code_type_id']) ? $data['external_code_type_id'] : 1;
     ...
     *
     * @param int $external_code_type_id The unique id of the external code type (provided by your account manager)
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value Value of external code
     *
     * @return $this
     */
