...
/**
 * RewardProductRelationCondition Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RewardProductRelationCondition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RewardProductRelationCondition';
...
self::RELATED_TO_PRODUCT_BRAND,        ];
     ...
     * Sets count
     *
     * @param int $count Count of the type(product, group or brand) in the shopping cart to fulfill the condition.
     *
     * @return $this
     */
     ...
     * Sets min_price
     *
     * @param float $min_price Minimum price of the type (product, group, brand) in the shopping cart to fulfill the condition.
     *
     * @return $this
     */
     ...
     * Sets max_price
     *
     * @param float $max_price Maximum price of the type (product, group, brand) in the shopping cart to fulfill the condition.
     *
     * @return $this
     */
