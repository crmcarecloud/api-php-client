<?php
/**
 * CampaignProductIdCampaignproductstorerecordsBody
 *
 * PHP version 5
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignProductIdCampaignproductstorerecordsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'campaign_product_id_campaignproductstorerecords_body';
    ...
    protected static $attributeMap = [
        'campaign_product_store_record' => 'campaign_product_store_record'    ];
    ...
    protected static $setters = [
        'campaign_product_store_record' => 'setCampaignProductStoreRecord'    ];
    ...
    protected static $getters = [
        'campaign_product_store_record' => 'getCampaignProductStoreRecord'    ];
    ...
    {
        $this->container['campaign_product_store_record'] = isset($data['campaign_product_store_record']) ? $data['campaign_product_store_record'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['campaign_product_store_record'] === null) {
            $invalidProperties[] = "'campaign_product_store_record' can't be null";
        }
    ...
    {
        return $this->container['campaign_product_store_record'];
    }
     ...
     * @return $this
     */
    public function setCampaignProductStoreRecord($campaign_product_store_record)
    {
        $this->container['campaign_product_store_record'] = $campaign_product_store_record;
