...
/**
 * ActionsNewsletterssignupBody Class Doc Comment
 *
 * @category Class
 * @package  CrmCareCloud\Webservice\RestApi\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActionsNewsletterssignupBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'actions_newsletterssignup_body';
     ...
     * Sets contact
     *
     * @param string $contact The parameter could contain email, phone number or other identifier of the contact.
     *
     * @return $this
     */
