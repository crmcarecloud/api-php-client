...
docker run --rm -v $PROJECT_DIRECTORY:/local swaggerapi/swagger-codegen-cli-v3:3.0.26 generate -i /local/deps/vendor/carecloud/api-spec/_build/openapi.yaml -l php -o /local -t /local/resources/php -c /local/client-config.json
